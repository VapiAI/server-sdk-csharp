...
[Serializable]
public record BoardControllerFindAllRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public BoardControllerFindAllRequestSortOrder? SortOrder { get; set; }

    /// <summary>
    /// This is the column to sort by. Defaults to 'createdAt'.
    /// </summary>
    [JsonIgnore]
    public BoardControllerFindAllRequestSortBy? SortBy { get; set; }

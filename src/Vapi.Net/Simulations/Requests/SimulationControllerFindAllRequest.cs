...
[Serializable]
public record SimulationControllerFindAllRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public SimulationControllerFindAllRequestSortOrder? SortOrder { get; set; }

    /// <summary>
    /// This is the column to sort by. Defaults to 'createdAt'.
    /// </summary>
    [JsonIgnore]
    public SimulationControllerFindAllRequestSortBy? SortBy { get; set; }

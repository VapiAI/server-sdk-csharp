...
[Serializable]
public record CampaignControllerFindAllPaginatedRequest
{
    [JsonIgnore]
    public string? Id { get; set; }

    [JsonIgnore]
    public CampaignControllerFindAllPaginatedRequestStatus? Status { get; set; }
    ...
    /// </summary>
    [JsonIgnore]
    public CampaignControllerFindAllPaginatedRequestSortOrder? SortOrder { get; set; }

...
public partial class ChatsClient : IChatsClient
{
    ...
    private async Task<WithRawResponse<ChatPaginatedResponse>> ListAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<ChatPaginatedResponse>(responseBody)!;
                return new WithRawResponse<ChatPaginatedResponse>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<OneOf<Chat, CreateChatStreamResponse>>> CreateAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<OneOf<Chat, CreateChatStreamResponse>>(
                    responseBody
                )!;
                return new WithRawResponse<OneOf<Chat, CreateChatStreamResponse>>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<Chat>> GetAsyncCore(
        string id,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<Chat>(responseBody)!;
                return new WithRawResponse<Chat>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<Chat>> DeleteAsyncCore(
        string id,
    ...
    public WithRawResponseTask<ChatPaginatedResponse> ListAsync(
        ListChatsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ChatPaginatedResponse>(
    ...
    /// </summary>
    public WithRawResponseTask<OneOf<Chat, CreateChatStreamResponse>> CreateAsync(
        CreateChatDto request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<OneOf<Chat, CreateChatStreamResponse>>(
            CreateAsyncCore(request, options, cancellationToken)
        );
    }

    public WithRawResponseTask<Chat> GetAsync(
        string id,
        GetChatsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<Chat>(GetAsyncCore(id, request, options, cancellationToken));
    }

    public WithRawResponseTask<Chat> DeleteAsync(
        string id,
        DeleteChatsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<Chat>(

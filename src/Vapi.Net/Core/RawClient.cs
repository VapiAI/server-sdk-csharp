...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::Vapi.Net.Core.ApiResponse> SendRequestAsync(
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::Vapi.Net.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    private string BuildUrl(global::Vapi.Net.Core.BaseRequest request)
    {

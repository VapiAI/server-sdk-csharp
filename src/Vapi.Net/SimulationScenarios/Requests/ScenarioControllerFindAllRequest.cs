...
[Serializable]
public record ScenarioControllerFindAllRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public ScenarioControllerFindAllRequestSortOrder? SortOrder { get; set; }

    /// <summary>
    /// This is the column to sort by. Defaults to 'createdAt'.
    /// </summary>
    [JsonIgnore]
    public ScenarioControllerFindAllRequestSortBy? SortBy { get; set; }

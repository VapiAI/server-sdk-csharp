...
[Serializable]
public record UpdateAssistantDraftDto : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public UpdateAssistantDraftDtoFirstMessageMode? FirstMessageMode { get; set; }
    ...
    public IEnumerable<UpdateAssistantDraftDtoClientMessagesItem>? ClientMessages { get; set; }
    ...
    public IEnumerable<UpdateAssistantDraftDtoServerMessagesItem>? ServerMessages { get; set; }
    ...
    public OneOf<UpdateAssistantDraftDtoBackgroundSoundZero, string>? BackgroundSound { get; set; }

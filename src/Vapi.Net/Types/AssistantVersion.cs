...
[Serializable]
public record AssistantVersion : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public AssistantVersionFirstMessageMode? FirstMessageMode { get; set; }
    ...
    public IEnumerable<AssistantVersionClientMessagesItem>? ClientMessages { get; set; }
    ...
    public IEnumerable<AssistantVersionServerMessagesItem>? ServerMessages { get; set; }
    ...
    public OneOf<AssistantVersionBackgroundSoundZero, string>? BackgroundSound { get; set; }

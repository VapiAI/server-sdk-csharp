    ...
    : global::System.Text.Json.Serialization.JsonConverter<AssemblyAiTranscriberLanguageCodesItem>
{
    ...
    > _stringToEnum = new()
    {
        ...
        { "ur", AssemblyAiTranscriberLanguageCodesItem.Ur },
        { "ru", AssemblyAiTranscriberLanguageCodesItem.Ru },
        { "ko", AssemblyAiTranscriberLanguageCodesItem.Ko },
        { "ca", AssemblyAiTranscriberLanguageCodesItem.Ca },
        { "gl", AssemblyAiTranscriberLanguageCodesItem.Gl },
        { "ro", AssemblyAiTranscriberLanguageCodesItem.Ro },
        { "et", AssemblyAiTranscriberLanguageCodesItem.Et },
        { "fa", AssemblyAiTranscriberLanguageCodesItem.Fa },
        { "yue", AssemblyAiTranscriberLanguageCodesItem.Yue },
        { "af", AssemblyAiTranscriberLanguageCodesItem.Af },
        { "mr", AssemblyAiTranscriberLanguageCodesItem.Mr },
        { "zu", AssemblyAiTranscriberLanguageCodesItem.Zu },
        { "xh", AssemblyAiTranscriberLanguageCodesItem.Xh },
        { "nn", AssemblyAiTranscriberLanguageCodesItem.Nn },
    };
    ...
    > _enumToString = new()
    {
        ...
        { AssemblyAiTranscriberLanguageCodesItem.Ur, "ur" },
        { AssemblyAiTranscriberLanguageCodesItem.Ru, "ru" },
        { AssemblyAiTranscriberLanguageCodesItem.Ko, "ko" },
        { AssemblyAiTranscriberLanguageCodesItem.Ca, "ca" },
        { AssemblyAiTranscriberLanguageCodesItem.Gl, "gl" },
        { AssemblyAiTranscriberLanguageCodesItem.Ro, "ro" },
        { AssemblyAiTranscriberLanguageCodesItem.Et, "et" },
        { AssemblyAiTranscriberLanguageCodesItem.Fa, "fa" },
        { AssemblyAiTranscriberLanguageCodesItem.Yue, "yue" },
        { AssemblyAiTranscriberLanguageCodesItem.Af, "af" },
        { AssemblyAiTranscriberLanguageCodesItem.Mr, "mr" },
        { AssemblyAiTranscriberLanguageCodesItem.Zu, "zu" },
        { AssemblyAiTranscriberLanguageCodesItem.Xh, "xh" },
        { AssemblyAiTranscriberLanguageCodesItem.Nn, "nn" },
    };

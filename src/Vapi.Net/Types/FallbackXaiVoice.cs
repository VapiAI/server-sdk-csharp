...
[Serializable]
public record FallbackXaiVoice : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required FallbackXaiVoiceVoiceId VoiceId { get; set; }

    /// <summary>
    /// BCP-47 language code for xAI TTS synthesis.
    /// </summary>
    [JsonPropertyName("language")]
    public FallbackXaiVoiceLanguage? Language { get; set; }

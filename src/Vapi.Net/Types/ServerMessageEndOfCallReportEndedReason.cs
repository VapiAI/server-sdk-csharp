...
[JsonConverter(typeof(ServerMessageEndOfCallReportEndedReasonSerializer))]
public enum ServerMessageEndOfCallReportEndedReason
{
    ...
    [EnumMember(Value = "call.start.squad-version-error-validation")]
    ...
    [EnumMember(Value = "sip-outbound-unallocated-number")]
    SipOutboundUnallocatedNumber,

    [EnumMember(Value = "sip-outbound-carrier-released-call")]
...
internal class ServerMessageEndOfCallReportEndedReasonSerializer
    : global::System.Text.Json.Serialization.JsonConverter<ServerMessageEndOfCallReportEndedReason>
{
    ...
    {
        {
            ...
            ServerMessageEndOfCallReportEndedReason.CallStartErrorNeitherAssistantNorServerSet
        },
        {
            "assistant-request-failed",
            ServerMessageEndOfCallReportEndedReason.AssistantRequestFailed
        },
        {
            "assistant-request-returned-error",
            ServerMessageEndOfCallReportEndedReason.AssistantRequestReturnedError
        },
        {
            "assistant-request-returned-unspeakable-error",
            ServerMessageEndOfCallReportEndedReason.AssistantRequestReturnedUnspeakableError
        },
        {
            "assistant-request-returned-invalid-assistant",
            ServerMessageEndOfCallReportEndedReason.AssistantRequestReturnedInvalidAssistant
        },
        {
            "assistant-request-returned-no-assistant",
            ServerMessageEndOfCallReportEndedReason.AssistantRequestReturnedNoAssistant
        },
        {
            "assistant-request-returned-forwarding-phone-number",
            ServerMessageEndOfCallReportEndedReason.AssistantRequestReturnedForwardingPhoneNumber
        },
        { "scheduled-call-deleted", ServerMessageEndOfCallReportEndedReason.ScheduledCallDeleted },
        {
            "call.start.error-vapifault-get-org",
            ServerMessageEndOfCallReportEndedReason.CallStartErrorVapifaultGetOrg
        },
        {
            "call.start.error-vapifault-get-subscription",
            ServerMessageEndOfCallReportEndedReason.CallStartErrorVapifaultGetSubscription
        },
        {
            "call.start.error-get-assistant",
            ServerMessageEndOfCallReportEndedReason.CallStartErrorGetAssistant
        },
        {
            "call.start.error-get-phone-number",
            ServerMessageEndOfCallReportEndedReason.CallStartErrorGetPhoneNumber
        },
        {
            "call.start.error-get-customer",
            ServerMessageEndOfCallReportEndedReason.CallStartErrorGetCustomer
        },
        {
            "call.start.error-get-resources-validation",
            ServerMessageEndOfCallReportEndedReason.CallStartErrorGetResourcesValidation
        },
        {
            "call.start.error-vapi-number-international",
            ServerMessageEndOfCallReportEndedReason.CallStartErrorVapiNumberInternational
        },
        {
            "call.start.error-vapi-number-outbound-daily-limit",
            ServerMessageEndOfCallReportEndedReason.CallStartErrorVapiNumberOutboundDailyLimit
        },
        {
            "call.start.error-get-transport",
            ServerMessageEndOfCallReportEndedReason.CallStartErrorGetTransport
        },
        {
            "call.start.error-subscription-wallet-does-not-exist",
            ServerMessageEndOfCallReportEndedReason.CallStartErrorSubscriptionWalletDoesNotExist
        },
        {
            "call.start.error-fraud-check-failed",
            ServerMessageEndOfCallReportEndedReason.CallStartErrorFraudCheckFailed
        },
        {
            "call.start.error-subscription-frozen",
            ServerMessageEndOfCallReportEndedReason.CallStartErrorSubscriptionFrozen
        },
        {
            "call.start.error-subscription-insufficient-credits",
            ServerMessageEndOfCallReportEndedReason.CallStartErrorSubscriptionInsufficientCredits
        },
        {
            "call.start.error-subscription-upgrade-failed",
            ServerMessageEndOfCallReportEndedReason.CallStartErrorSubscriptionUpgradeFailed
        },
        {
            "call.start.error-subscription-concurrency-limit-reached",
            ServerMessageEndOfCallReportEndedReason.CallStartErrorSubscriptionConcurrencyLimitReached
        },
        {
            "call.start.error-enterprise-feature-not-available-recording-consent",
            ServerMessageEndOfCallReportEndedReason.CallStartErrorEnterpriseFeatureNotAvailableRecordingConsent
        },
        {
            "call.start.assistant-version-error-validation",
            ServerMessageEndOfCallReportEndedReason.CallStartAssistantVersionErrorValidation
        },
        {
            "call.start.squad-version-error-validation",
            ServerMessageEndOfCallReportEndedReason.CallStartSquadVersionErrorValidation
        },
        { "assistant-not-valid", ServerMessageEndOfCallReportEndedReason.AssistantNotValid },
        {
            "call.start.error-vapifault-database-error",
            ServerMessageEndOfCallReportEndedReason.CallStartErrorVapifaultDatabaseError
        },
        { "assistant-not-found", ServerMessageEndOfCallReportEndedReason.AssistantNotFound },
        {
            "pipeline-error-openai-voice-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorOpenaiVoiceFailed
        },
        {
            "pipeline-error-cartesia-voice-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCartesiaVoiceFailed
        },
        {
            "pipeline-error-deepgram-voice-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepgramVoiceFailed
        },
        {
            "pipeline-error-eleven-labs-voice-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsVoiceFailed
        },
        {
            "pipeline-error-playht-voice-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorPlayhtVoiceFailed
        },
        {
            "pipeline-error-lmnt-voice-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorLmntVoiceFailed
        },
        {
            "pipeline-error-azure-voice-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAzureVoiceFailed
        },
        {
            "pipeline-error-rime-ai-voice-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorRimeAiVoiceFailed
        },
        {
            "pipeline-error-smallest-ai-voice-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorSmallestAiVoiceFailed
        },
        {
            "pipeline-error-vapi-voice-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorVapiVoiceFailed
        },
        {
            "pipeline-error-neuphonic-voice-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorNeuphonicVoiceFailed
        },
        {
            "pipeline-error-hume-voice-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorHumeVoiceFailed
        },
        {
            "pipeline-error-sesame-voice-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorSesameVoiceFailed
        },
        {
            "pipeline-error-inworld-voice-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorInworldVoiceFailed
        },
        {
            "pipeline-error-minimax-voice-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorMinimaxVoiceFailed
        },
        {
        ...
        },
        {
            ...
            ServerMessageEndOfCallReportEndedReason.PipelineErrorXaiVoiceFailed
        },
        {
            "pipeline-error-microsoft-voice-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorMicrosoftVoiceFailed
        },
        {
            "pipeline-error-microsoft-voice-request-canceled",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorMicrosoftVoiceRequestCanceled
        },
        {
            "pipeline-error-tavus-video-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorTavusVideoFailed
        },
        {
            "call.in-progress.error-vapifault-openai-voice-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultOpenaiVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-cartesia-voice-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultCartesiaVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-deepgram-voice-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultDeepgramVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-voice-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-playht-voice-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultPlayhtVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-lmnt-voice-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultLmntVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-azure-voice-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAzureVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-rime-ai-voice-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultRimeAiVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-smallest-ai-voice-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultSmallestAiVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-vapi-voice-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultVapiVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-neuphonic-voice-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultNeuphonicVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-hume-voice-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultHumeVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-sesame-voice-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultSesameVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-inworld-voice-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultInworldVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-minimax-voice-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultMinimaxVoiceFailed
        },
        {
        ...
        },
        {
            ...
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultXaiVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-microsoft-voice-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultMicrosoftVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-tavus-video-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultTavusVideoFailed
        },
        {
            "pipeline-error-vapi-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorVapiLlmFailed
        },
        {
            "pipeline-error-vapi-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorVapi400BadRequestValidationFailed
        },
        {
            "pipeline-error-vapi-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorVapi401Unauthorized
        },
        {
            "pipeline-error-vapi-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorVapi403ModelAccessDenied
        },
        {
            "pipeline-error-vapi-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorVapi429ExceededQuota
        },
        {
            "pipeline-error-vapi-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorVapi500ServerError
        },
        {
            "pipeline-error-vapi-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorVapi503ServerOverloadedError
        },
        {
            "call.in-progress.error-providerfault-vapi-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultVapiLlmFailed
        },
        {
            "call.in-progress.error-vapifault-vapi-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultVapiLlmFailed
        },
        {
            "call.in-progress.error-vapifault-vapi-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultVapi400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-vapi-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultVapi401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-vapi-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultVapi403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-vapi-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultVapi429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-vapi-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultVapi500ServerError
        },
        {
            "call.in-progress.error-providerfault-vapi-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultVapi503ServerOverloadedError
        },
        {
            "pipeline-error-vapi-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorVapiTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-vapi-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultVapiTranscriberFailed
        },
        {
            "call.in-progress.error-providerfault-vapi-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultVapiTranscriberFailed
        },
        {
            "call.in-progress.error-providerfault-vapi-voice-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultVapiVoiceFailed
        },
        {
            "pipeline-error-deepgram-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepgramTranscriberFailed
        },
        {
            "pipeline-error-deepgram-transcriber-api-key-missing",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepgramTranscriberApiKeyMissing
        },
        {
            "call.in-progress.error-vapifault-deepgram-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultDeepgramTranscriberFailed
        },
        {
            "pipeline-error-gladia-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorGladiaTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-gladia-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultGladiaTranscriberFailed
        },
        {
            "pipeline-error-speechmatics-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorSpeechmaticsTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-speechmatics-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultSpeechmaticsTranscriberFailed
        },
        {
            "pipeline-error-assembly-ai-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAssemblyAiTranscriberFailed
        },
        {
            "pipeline-error-assembly-ai-returning-400-insufficent-funds",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAssemblyAiReturning400InsufficentFunds
        },
        {
            "pipeline-error-assembly-ai-returning-400-paid-only-feature",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAssemblyAiReturning400PaidOnlyFeature
        },
        {
            "pipeline-error-assembly-ai-returning-401-invalid-credentials",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAssemblyAiReturning401InvalidCredentials
        },
        {
            "pipeline-error-assembly-ai-returning-500-invalid-schema",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAssemblyAiReturning500InvalidSchema
        },
        {
            "pipeline-error-assembly-ai-returning-500-word-boost-parsing-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAssemblyAiReturning500WordBoostParsingFailed
        },
        {
            "call.in-progress.error-vapifault-assembly-ai-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAssemblyAiTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-assembly-ai-returning-400-insufficent-funds",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAssemblyAiReturning400InsufficentFunds
        },
        {
            "call.in-progress.error-vapifault-assembly-ai-returning-400-paid-only-feature",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAssemblyAiReturning400PaidOnlyFeature
        },
        {
            "call.in-progress.error-vapifault-assembly-ai-returning-401-invalid-credentials",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAssemblyAiReturning401InvalidCredentials
        },
        {
            "call.in-progress.error-vapifault-assembly-ai-returning-500-invalid-schema",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAssemblyAiReturning500InvalidSchema
        },
        {
            "call.in-progress.error-vapifault-assembly-ai-returning-500-word-boost-parsing-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAssemblyAiReturning500WordBoostParsingFailed
        },
        {
            "pipeline-error-talkscriber-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorTalkscriberTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-talkscriber-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultTalkscriberTranscriberFailed
        },
        {
            "pipeline-error-azure-speech-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAzureSpeechTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-azure-speech-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAzureSpeechTranscriberFailed
        },
        {
            "pipeline-error-eleven-labs-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsTranscriberFailed
        },
        {
            "pipeline-error-google-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorGoogleTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-google-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultGoogleTranscriberFailed
        },
        {
            "pipeline-error-openai-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorOpenaiTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-openai-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultOpenaiTranscriberFailed
        },
        {
            "pipeline-error-soniox-transcriber-auth-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorSonioxTranscriberAuthFailed
        },
        {
            "pipeline-error-soniox-transcriber-rate-limited",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorSonioxTranscriberRateLimited
        },
        {
            "pipeline-error-soniox-transcriber-invalid-config",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorSonioxTranscriberInvalidConfig
        },
        {
            "pipeline-error-soniox-transcriber-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorSonioxTranscriberServerError
        },
        {
            "pipeline-error-soniox-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorSonioxTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-soniox-transcriber-auth-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultSonioxTranscriberAuthFailed
        },
        {
            "call.in-progress.error-vapifault-soniox-transcriber-rate-limited",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultSonioxTranscriberRateLimited
        },
        {
            "call.in-progress.error-vapifault-soniox-transcriber-invalid-config",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultSonioxTranscriberInvalidConfig
        },
        {
            "call.in-progress.error-vapifault-soniox-transcriber-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultSonioxTranscriberServerError
        },
        {
            "call.in-progress.error-vapifault-soniox-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultSonioxTranscriberFailed
        },
        {
            "pipeline-error-xai-transcriber-auth-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorXaiTranscriberAuthFailed
        },
        {
            "pipeline-error-xai-transcriber-rate-limited",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorXaiTranscriberRateLimited
        },
        {
            "pipeline-error-xai-transcriber-invalid-config",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorXaiTranscriberInvalidConfig
        },
        {
            "pipeline-error-xai-transcriber-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorXaiTranscriberServerError
        },
        {
            "pipeline-error-xai-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorXaiTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-xai-transcriber-auth-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultXaiTranscriberAuthFailed
        },
        {
            "call.in-progress.error-vapifault-xai-transcriber-rate-limited",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultXaiTranscriberRateLimited
        },
        {
            "call.in-progress.error-vapifault-xai-transcriber-invalid-config",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultXaiTranscriberInvalidConfig
        },
        {
            "call.in-progress.error-vapifault-xai-transcriber-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultXaiTranscriberServerError
        },
        {
            "call.in-progress.error-vapifault-xai-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultXaiTranscriberFailed
        },
        {
            "pipeline-error-cartesia-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCartesiaTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-cartesia-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultCartesiaTranscriberFailed
        },
        {
            "call.in-progress.error-pipeline-no-available-llm-model",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorPipelineNoAvailableLlmModel
        },
        ...
        { "vonage-disconnected", ServerMessageEndOfCallReportEndedReason.VonageDisconnected },
        {
            ...
            ServerMessageEndOfCallReportEndedReason.VonageFailedToConnectCall
        },
        { "vonage-completed", ServerMessageEndOfCallReportEndedReason.VonageCompleted },
        {
            "phone-call-provider-bypass-enabled-but-no-call-received",
            ServerMessageEndOfCallReportEndedReason.PhoneCallProviderBypassEnabledButNoCallReceived
        },
        {
            "call.in-progress.error-providerfault-transport-never-connected",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultTransportNeverConnected
        },
        {
            "call.in-progress.error-vapifault-worker-not-available",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultWorkerNotAvailable
        },
        {
            "call.in-progress.error-vapifault-transport-never-connected",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultTransportNeverConnected
        },
        {
            "call.in-progress.error-vapifault-transport-connected-but-call-not-active",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultTransportConnectedButCallNotActive
        },
        {
            "call.in-progress.error-vapifault-call-started-but-connection-to-transport-missing",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultCallStartedButConnectionToTransportMissing
        },
        {
            "call.in-progress.error-vapifault-worker-died",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultWorkerDied
        },
        {
            "call.in-progress.twilio-completed-call",
            ServerMessageEndOfCallReportEndedReason.CallInProgressTwilioCompletedCall
        },
        {
            "call.in-progress.sip-completed-call",
            ServerMessageEndOfCallReportEndedReason.CallInProgressSipCompletedCall
        },
        {
            "call.in-progress.error-sip-inbound-call-failed-to-connect",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorSipInboundCallFailedToConnect
        },
        {
            "call.in-progress.error-providerfault-outbound-sip-503-service-unavailable",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultOutboundSip503ServiceUnavailable
        },
        {
            "call.in-progress.error-sip-outbound-call-failed-to-connect",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorSipOutboundCallFailedToConnect
        },
        {
            "call.ringing.error-sip-inbound-call-failed-to-connect",
            ServerMessageEndOfCallReportEndedReason.CallRingingErrorSipInboundCallFailedToConnect
        },
        {
            "call.in-progress.error-providerfault-openai-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultOpenaiLlmFailed
        },
        {
            "call.in-progress.error-providerfault-azure-openai-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultAzureOpenaiLlmFailed
        },
        {
            "call.in-progress.error-providerfault-groq-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultGroqLlmFailed
        },
        {
            "call.in-progress.error-providerfault-google-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultGoogleLlmFailed
        },
        {
            "call.in-progress.error-providerfault-xai-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultXaiLlmFailed
        },
        {
            "call.in-progress.error-providerfault-mistral-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultMistralLlmFailed
        },
        {
            "call.in-progress.error-providerfault-minimax-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultMinimaxLlmFailed
        },
        {
            "call.in-progress.error-providerfault-inflection-ai-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultInflectionAiLlmFailed
        },
        {
            "call.in-progress.error-providerfault-cerebras-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultCerebrasLlmFailed
        },
        {
            "call.in-progress.error-providerfault-deep-seek-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultDeepSeekLlmFailed
        },
        {
            "call.in-progress.error-providerfault-baseten-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultBasetenLlmFailed
        },
        {
            "call.in-progress.error-vapifault-chat-pipeline-failed-to-start",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultChatPipelineFailedToStart
        },
        {
            "call.in-progress.error-configfault-model-unsupported-in-squad",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorConfigfaultModelUnsupportedInSquad
        },
        {
            "call.in-progress.error-configfault-transport-unsupported-for-model",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorConfigfaultTransportUnsupportedForModel
        },
        {
            "pipeline-error-openai-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorOpenai400BadRequestValidationFailed
        },
        {
            "pipeline-error-openai-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorOpenai401Unauthorized
        },
        {
            "pipeline-error-openai-401-incorrect-api-key",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorOpenai401IncorrectApiKey
        },
        {
            "pipeline-error-openai-401-account-not-in-organization",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorOpenai401AccountNotInOrganization
        },
        {
            "pipeline-error-openai-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorOpenai403ModelAccessDenied
        },
        {
            "pipeline-error-openai-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorOpenai429ExceededQuota
        },
        {
            "pipeline-error-openai-429-rate-limit-reached",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorOpenai429RateLimitReached
        },
        {
            "pipeline-error-openai-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorOpenai500ServerError
        },
        {
            "pipeline-error-openai-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorOpenai503ServerOverloadedError
        },
        {
            "pipeline-error-openai-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorOpenaiLlmFailed
        },
        {
            "call.in-progress.error-vapifault-openai-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultOpenai400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-openai-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultOpenai401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-openai-401-incorrect-api-key",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultOpenai401IncorrectApiKey
        },
        {
            "call.in-progress.error-vapifault-openai-401-account-not-in-organization",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultOpenai401AccountNotInOrganization
        },
        {
            "call.in-progress.error-vapifault-openai-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultOpenai403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-openai-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultOpenai429ExceededQuota
        },
        {
            "call.in-progress.error-vapifault-openai-429-rate-limit-reached",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultOpenai429RateLimitReached
        },
        {
            "call.in-progress.error-providerfault-openai-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultOpenai500ServerError
        },
        {
            "call.in-progress.error-providerfault-openai-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultOpenai503ServerOverloadedError
        },
        {
            "pipeline-error-azure-openai-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAzureOpenai400BadRequestValidationFailed
        },
        {
            "pipeline-error-azure-openai-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAzureOpenai401Unauthorized
        },
        {
            "pipeline-error-azure-openai-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAzureOpenai403ModelAccessDenied
        },
        {
            "pipeline-error-azure-openai-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAzureOpenai429ExceededQuota
        },
        {
            "pipeline-error-azure-openai-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAzureOpenai500ServerError
        },
        {
            "pipeline-error-azure-openai-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAzureOpenai503ServerOverloadedError
        },
        {
            "pipeline-error-azure-openai-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAzureOpenaiLlmFailed
        },
        {
            "call.in-progress.error-vapifault-azure-openai-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAzureOpenai400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-azure-openai-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAzureOpenai401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-azure-openai-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAzureOpenai403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-azure-openai-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAzureOpenai429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-azure-openai-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultAzureOpenai500ServerError
        },
        {
            "call.in-progress.error-providerfault-azure-openai-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultAzureOpenai503ServerOverloadedError
        },
        {
            "pipeline-error-google-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorGoogle400BadRequestValidationFailed
        },
        {
            "pipeline-error-google-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorGoogle401Unauthorized
        },
        {
            "pipeline-error-google-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorGoogle403ModelAccessDenied
        },
        {
            "pipeline-error-google-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorGoogle429ExceededQuota
        },
        {
            "pipeline-error-google-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorGoogle500ServerError
        },
        {
            "pipeline-error-google-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorGoogle503ServerOverloadedError
        },
        {
            "pipeline-error-google-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorGoogleLlmFailed
        },
        {
            "call.in-progress.error-vapifault-google-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultGoogle400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-google-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultGoogle401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-google-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultGoogle403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-google-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultGoogle429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-google-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultGoogle500ServerError
        },
        {
            "call.in-progress.error-providerfault-google-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultGoogle503ServerOverloadedError
        },
        {
            "pipeline-error-xai-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorXai400BadRequestValidationFailed
        },
        {
            "pipeline-error-xai-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorXai401Unauthorized
        },
        {
            "pipeline-error-xai-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorXai403ModelAccessDenied
        },
        {
            "pipeline-error-xai-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorXai429ExceededQuota
        },
        {
            "pipeline-error-xai-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorXai500ServerError
        },
        {
            "pipeline-error-xai-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorXai503ServerOverloadedError
        },
        {
            "pipeline-error-xai-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorXaiLlmFailed
        },
        {
            "call.in-progress.error-vapifault-xai-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultXai400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-xai-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultXai401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-xai-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultXai403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-xai-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultXai429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-xai-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultXai500ServerError
        },
        {
            "call.in-progress.error-providerfault-xai-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultXai503ServerOverloadedError
        },
        {
            "pipeline-error-baseten-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorBaseten400BadRequestValidationFailed
        },
        {
            "pipeline-error-baseten-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorBaseten401Unauthorized
        },
        {
            "pipeline-error-baseten-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorBaseten403ModelAccessDenied
        },
        {
            "pipeline-error-baseten-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorBaseten429ExceededQuota
        },
        {
            "pipeline-error-baseten-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorBaseten500ServerError
        },
        {
            "pipeline-error-baseten-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorBaseten503ServerOverloadedError
        },
        {
            "pipeline-error-baseten-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorBasetenLlmFailed
        },
        {
            "call.in-progress.error-vapifault-baseten-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultBaseten400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-baseten-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultBaseten401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-baseten-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultBaseten403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-baseten-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultBaseten429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-baseten-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultBaseten500ServerError
        },
        {
            "call.in-progress.error-providerfault-baseten-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultBaseten503ServerOverloadedError
        },
        {
            "pipeline-error-mistral-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorMistral400BadRequestValidationFailed
        },
        {
            "pipeline-error-mistral-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorMistral401Unauthorized
        },
        {
            "pipeline-error-mistral-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorMistral403ModelAccessDenied
        },
        {
            "pipeline-error-mistral-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorMistral429ExceededQuota
        },
        {
            "pipeline-error-mistral-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorMistral500ServerError
        },
        {
            "pipeline-error-mistral-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorMistral503ServerOverloadedError
        },
        {
            "pipeline-error-mistral-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorMistralLlmFailed
        },
        {
            "call.in-progress.error-vapifault-mistral-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultMistral400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-mistral-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultMistral401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-mistral-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultMistral403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-mistral-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultMistral429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-mistral-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultMistral500ServerError
        },
        {
            "call.in-progress.error-providerfault-mistral-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultMistral503ServerOverloadedError
        },
        {
            "pipeline-error-minimax-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorMinimax400BadRequestValidationFailed
        },
        {
            "pipeline-error-minimax-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorMinimax401Unauthorized
        },
        {
            "pipeline-error-minimax-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorMinimax403ModelAccessDenied
        },
        {
            "pipeline-error-minimax-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorMinimax429ExceededQuota
        },
        {
            "pipeline-error-minimax-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorMinimax500ServerError
        },
        {
            "pipeline-error-minimax-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorMinimax503ServerOverloadedError
        },
        {
            "pipeline-error-minimax-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorMinimaxLlmFailed
        },
        {
            "call.in-progress.error-vapifault-minimax-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultMinimax400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-minimax-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultMinimax401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-minimax-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultMinimax403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-minimax-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultMinimax429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-minimax-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultMinimax500ServerError
        },
        {
            "call.in-progress.error-providerfault-minimax-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultMinimax503ServerOverloadedError
        },
        {
            "pipeline-error-inflection-ai-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorInflectionAi400BadRequestValidationFailed
        },
        {
            "pipeline-error-inflection-ai-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorInflectionAi401Unauthorized
        },
        {
            "pipeline-error-inflection-ai-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorInflectionAi403ModelAccessDenied
        },
        {
            "pipeline-error-inflection-ai-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorInflectionAi429ExceededQuota
        },
        {
            "pipeline-error-inflection-ai-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorInflectionAi500ServerError
        },
        {
            "pipeline-error-inflection-ai-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorInflectionAi503ServerOverloadedError
        },
        {
            "pipeline-error-inflection-ai-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorInflectionAiLlmFailed
        },
        {
            "call.in-progress.error-vapifault-inflection-ai-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultInflectionAi400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-inflection-ai-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultInflectionAi401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-inflection-ai-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultInflectionAi403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-inflection-ai-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultInflectionAi429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-inflection-ai-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultInflectionAi500ServerError
        },
        {
            "call.in-progress.error-providerfault-inflection-ai-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultInflectionAi503ServerOverloadedError
        },
        {
            "pipeline-error-deep-seek-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepSeek400BadRequestValidationFailed
        },
        {
            "pipeline-error-deep-seek-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepSeek401Unauthorized
        },
        {
            "pipeline-error-deep-seek-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepSeek403ModelAccessDenied
        },
        {
            "pipeline-error-deep-seek-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepSeek429ExceededQuota
        },
        {
            "pipeline-error-deep-seek-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepSeek500ServerError
        },
        {
            "pipeline-error-deep-seek-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepSeek503ServerOverloadedError
        },
        {
            "pipeline-error-deep-seek-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepSeekLlmFailed
        },
        {
            "call.in-progress.error-vapifault-deep-seek-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultDeepSeek400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-deep-seek-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultDeepSeek401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-deep-seek-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultDeepSeek403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-deep-seek-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultDeepSeek429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-deep-seek-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultDeepSeek500ServerError
        },
        {
            "call.in-progress.error-providerfault-deep-seek-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultDeepSeek503ServerOverloadedError
        },
        {
            "pipeline-error-groq-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorGroq400BadRequestValidationFailed
        },
        {
            "pipeline-error-groq-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorGroq401Unauthorized
        },
        {
            "pipeline-error-groq-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorGroq403ModelAccessDenied
        },
        {
            "pipeline-error-groq-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorGroq429ExceededQuota
        },
        {
            "pipeline-error-groq-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorGroq500ServerError
        },
        {
            "pipeline-error-groq-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorGroq503ServerOverloadedError
        },
        {
            "pipeline-error-groq-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorGroqLlmFailed
        },
        {
            "call.in-progress.error-vapifault-groq-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultGroq400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-groq-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultGroq401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-groq-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultGroq403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-groq-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultGroq429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-groq-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultGroq500ServerError
        },
        {
            "call.in-progress.error-providerfault-groq-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultGroq503ServerOverloadedError
        },
        {
            "pipeline-error-cerebras-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCerebras400BadRequestValidationFailed
        },
        {
            "pipeline-error-cerebras-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCerebras401Unauthorized
        },
        {
            "pipeline-error-cerebras-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCerebras403ModelAccessDenied
        },
        {
            "pipeline-error-cerebras-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCerebras429ExceededQuota
        },
        {
            "pipeline-error-cerebras-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCerebras500ServerError
        },
        {
            "pipeline-error-cerebras-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCerebras503ServerOverloadedError
        },
        {
            "pipeline-error-cerebras-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCerebrasLlmFailed
        },
        {
            "call.in-progress.error-vapifault-cerebras-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultCerebras400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-cerebras-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultCerebras401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-cerebras-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultCerebras403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-cerebras-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultCerebras429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-cerebras-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultCerebras500ServerError
        },
        {
            "call.in-progress.error-providerfault-cerebras-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultCerebras503ServerOverloadedError
        },
        {
            "pipeline-error-anthropic-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropic400BadRequestValidationFailed
        },
        {
            "pipeline-error-anthropic-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropic401Unauthorized
        },
        {
            "pipeline-error-anthropic-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropic403ModelAccessDenied
        },
        {
            "pipeline-error-anthropic-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropic429ExceededQuota
        },
        {
            "pipeline-error-anthropic-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropic500ServerError
        },
        {
            "pipeline-error-anthropic-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropic503ServerOverloadedError
        },
        {
            "pipeline-error-anthropic-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropicLlmFailed
        },
        {
            "call.in-progress.error-providerfault-anthropic-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultAnthropicLlmFailed
        },
        {
            "call.in-progress.error-vapifault-anthropic-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAnthropic400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-anthropic-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAnthropic401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-anthropic-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAnthropic403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-anthropic-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAnthropic429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-anthropic-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultAnthropic500ServerError
        },
        {
            "call.in-progress.error-providerfault-anthropic-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultAnthropic503ServerOverloadedError
        },
        {
            "pipeline-error-anthropic-bedrock-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropicBedrock400BadRequestValidationFailed
        },
        {
            "pipeline-error-anthropic-bedrock-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropicBedrock401Unauthorized
        },
        {
            "pipeline-error-anthropic-bedrock-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropicBedrock403ModelAccessDenied
        },
        {
            "pipeline-error-anthropic-bedrock-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropicBedrock429ExceededQuota
        },
        {
            "pipeline-error-anthropic-bedrock-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropicBedrock500ServerError
        },
        {
            "pipeline-error-anthropic-bedrock-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropicBedrock503ServerOverloadedError
        },
        {
            "pipeline-error-anthropic-bedrock-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropicBedrockLlmFailed
        },
        {
            "call.in-progress.error-providerfault-anthropic-bedrock-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultAnthropicBedrockLlmFailed
        },
        {
            "call.in-progress.error-vapifault-anthropic-bedrock-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAnthropicBedrock400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-anthropic-bedrock-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAnthropicBedrock401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-anthropic-bedrock-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAnthropicBedrock403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-anthropic-bedrock-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAnthropicBedrock429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-anthropic-bedrock-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultAnthropicBedrock500ServerError
        },
        {
            "call.in-progress.error-providerfault-anthropic-bedrock-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultAnthropicBedrock503ServerOverloadedError
        },
        {
            "pipeline-error-anthropic-vertex-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropicVertex400BadRequestValidationFailed
        },
        {
            "pipeline-error-anthropic-vertex-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropicVertex401Unauthorized
        },
        {
            "pipeline-error-anthropic-vertex-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropicVertex403ModelAccessDenied
        },
        {
            "pipeline-error-anthropic-vertex-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropicVertex429ExceededQuota
        },
        {
            "pipeline-error-anthropic-vertex-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropicVertex500ServerError
        },
        {
            "pipeline-error-anthropic-vertex-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropicVertex503ServerOverloadedError
        },
        {
            "pipeline-error-anthropic-vertex-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnthropicVertexLlmFailed
        },
        {
            "call.in-progress.error-providerfault-anthropic-vertex-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultAnthropicVertexLlmFailed
        },
        {
            "call.in-progress.error-vapifault-anthropic-vertex-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAnthropicVertex400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-anthropic-vertex-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAnthropicVertex401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-anthropic-vertex-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAnthropicVertex403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-anthropic-vertex-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAnthropicVertex429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-anthropic-vertex-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultAnthropicVertex500ServerError
        },
        {
            "call.in-progress.error-providerfault-anthropic-vertex-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultAnthropicVertex503ServerOverloadedError
        },
        {
            "pipeline-error-together-ai-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorTogetherAi400BadRequestValidationFailed
        },
        {
            "pipeline-error-together-ai-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorTogetherAi401Unauthorized
        },
        {
            "pipeline-error-together-ai-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorTogetherAi403ModelAccessDenied
        },
        {
            "pipeline-error-together-ai-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorTogetherAi429ExceededQuota
        },
        {
            "pipeline-error-together-ai-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorTogetherAi500ServerError
        },
        {
            "pipeline-error-together-ai-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorTogetherAi503ServerOverloadedError
        },
        {
            "pipeline-error-together-ai-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorTogetherAiLlmFailed
        },
        {
            "call.in-progress.error-providerfault-together-ai-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultTogetherAiLlmFailed
        },
        {
            "call.in-progress.error-vapifault-together-ai-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultTogetherAi400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-together-ai-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultTogetherAi401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-together-ai-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultTogetherAi403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-together-ai-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultTogetherAi429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-together-ai-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultTogetherAi500ServerError
        },
        {
            "call.in-progress.error-providerfault-together-ai-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultTogetherAi503ServerOverloadedError
        },
        {
            "pipeline-error-anyscale-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnyscale400BadRequestValidationFailed
        },
        {
            "pipeline-error-anyscale-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnyscale401Unauthorized
        },
        {
            "pipeline-error-anyscale-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnyscale403ModelAccessDenied
        },
        {
            "pipeline-error-anyscale-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnyscale429ExceededQuota
        },
        {
            "pipeline-error-anyscale-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnyscale500ServerError
        },
        {
            "pipeline-error-anyscale-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnyscale503ServerOverloadedError
        },
        {
            "pipeline-error-anyscale-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorAnyscaleLlmFailed
        },
        {
            "call.in-progress.error-providerfault-anyscale-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultAnyscaleLlmFailed
        },
        {
            "call.in-progress.error-vapifault-anyscale-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAnyscale400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-anyscale-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAnyscale401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-anyscale-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAnyscale403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-anyscale-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultAnyscale429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-anyscale-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultAnyscale500ServerError
        },
        {
            "call.in-progress.error-providerfault-anyscale-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultAnyscale503ServerOverloadedError
        },
        {
            "pipeline-error-openrouter-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorOpenrouter400BadRequestValidationFailed
        },
        {
            "pipeline-error-openrouter-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorOpenrouter401Unauthorized
        },
        {
            "pipeline-error-openrouter-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorOpenrouter403ModelAccessDenied
        },
        {
            "pipeline-error-openrouter-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorOpenrouter429ExceededQuota
        },
        {
            "pipeline-error-openrouter-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorOpenrouter500ServerError
        },
        {
            "pipeline-error-openrouter-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorOpenrouter503ServerOverloadedError
        },
        {
            "pipeline-error-openrouter-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorOpenrouterLlmFailed
        },
        {
            "call.in-progress.error-providerfault-openrouter-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultOpenrouterLlmFailed
        },
        {
            "call.in-progress.error-vapifault-openrouter-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultOpenrouter400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-openrouter-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultOpenrouter401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-openrouter-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultOpenrouter403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-openrouter-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultOpenrouter429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-openrouter-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultOpenrouter500ServerError
        },
        {
            "call.in-progress.error-providerfault-openrouter-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultOpenrouter503ServerOverloadedError
        },
        {
            "pipeline-error-perplexity-ai-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorPerplexityAi400BadRequestValidationFailed
        },
        {
            "pipeline-error-perplexity-ai-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorPerplexityAi401Unauthorized
        },
        {
            "pipeline-error-perplexity-ai-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorPerplexityAi403ModelAccessDenied
        },
        {
            "pipeline-error-perplexity-ai-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorPerplexityAi429ExceededQuota
        },
        {
            "pipeline-error-perplexity-ai-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorPerplexityAi500ServerError
        },
        {
            "pipeline-error-perplexity-ai-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorPerplexityAi503ServerOverloadedError
        },
        {
            "pipeline-error-perplexity-ai-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorPerplexityAiLlmFailed
        },
        {
            "call.in-progress.error-providerfault-perplexity-ai-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultPerplexityAiLlmFailed
        },
        {
            "call.in-progress.error-vapifault-perplexity-ai-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultPerplexityAi400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-perplexity-ai-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultPerplexityAi401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-perplexity-ai-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultPerplexityAi403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-perplexity-ai-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultPerplexityAi429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-perplexity-ai-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultPerplexityAi500ServerError
        },
        {
            "call.in-progress.error-providerfault-perplexity-ai-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultPerplexityAi503ServerOverloadedError
        },
        {
            "pipeline-error-deepinfra-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepinfra400BadRequestValidationFailed
        },
        {
            "pipeline-error-deepinfra-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepinfra401Unauthorized
        },
        {
            "pipeline-error-deepinfra-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepinfra403ModelAccessDenied
        },
        {
            "pipeline-error-deepinfra-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepinfra429ExceededQuota
        },
        {
            "pipeline-error-deepinfra-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepinfra500ServerError
        },
        {
            "pipeline-error-deepinfra-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepinfra503ServerOverloadedError
        },
        {
            "pipeline-error-deepinfra-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepinfraLlmFailed
        },
        {
            "call.in-progress.error-providerfault-deepinfra-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultDeepinfraLlmFailed
        },
        {
            "call.in-progress.error-vapifault-deepinfra-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultDeepinfra400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-deepinfra-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultDeepinfra401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-deepinfra-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultDeepinfra403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-deepinfra-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultDeepinfra429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-deepinfra-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultDeepinfra500ServerError
        },
        {
            "call.in-progress.error-providerfault-deepinfra-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultDeepinfra503ServerOverloadedError
        },
        {
            "pipeline-error-runpod-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorRunpod400BadRequestValidationFailed
        },
        {
            "pipeline-error-runpod-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorRunpod401Unauthorized
        },
        {
            "pipeline-error-runpod-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorRunpod403ModelAccessDenied
        },
        {
            "pipeline-error-runpod-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorRunpod429ExceededQuota
        },
        {
            "pipeline-error-runpod-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorRunpod500ServerError
        },
        {
            "pipeline-error-runpod-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorRunpod503ServerOverloadedError
        },
        {
            "pipeline-error-runpod-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorRunpodLlmFailed
        },
        {
            "call.in-progress.error-providerfault-runpod-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultRunpodLlmFailed
        },
        {
            "call.in-progress.error-vapifault-runpod-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultRunpod400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-runpod-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultRunpod401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-runpod-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultRunpod403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-runpod-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultRunpod429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-runpod-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultRunpod500ServerError
        },
        {
            "call.in-progress.error-providerfault-runpod-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultRunpod503ServerOverloadedError
        },
        {
            "pipeline-error-custom-llm-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCustomLlm400BadRequestValidationFailed
        },
        {
            "pipeline-error-custom-llm-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCustomLlm401Unauthorized
        },
        {
            "pipeline-error-custom-llm-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCustomLlm403ModelAccessDenied
        },
        {
            "pipeline-error-custom-llm-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCustomLlm429ExceededQuota
        },
        {
            "pipeline-error-custom-llm-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCustomLlm500ServerError
        },
        {
            "pipeline-error-custom-llm-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCustomLlm503ServerOverloadedError
        },
        {
            "pipeline-error-custom-llm-llm-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCustomLlmLlmFailed
        },
        {
            "call.in-progress.error-providerfault-custom-llm-llm-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultCustomLlmLlmFailed
        },
        {
            "call.in-progress.error-vapifault-custom-llm-400-bad-request-validation-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultCustomLlm400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-custom-llm-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultCustomLlm401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-custom-llm-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultCustomLlm403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-custom-llm-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultCustomLlm429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-custom-llm-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultCustomLlm500ServerError
        },
        {
            "call.in-progress.error-providerfault-custom-llm-503-server-overloaded-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultCustomLlm503ServerOverloadedError
        },
        {
            "call.in-progress.error-pipeline-ws-model-connection-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorPipelineWsModelConnectionFailed
        },
        {
            "pipeline-error-custom-voice-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCustomVoiceFailed
        },
        {
            "pipeline-error-cartesia-socket-hang-up",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCartesiaSocketHangUp
        },
        {
            "pipeline-error-cartesia-requested-payment",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCartesiaRequestedPayment
        },
        {
            "pipeline-error-cartesia-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCartesia500ServerError
        },
        {
            "pipeline-error-cartesia-502-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCartesia502ServerError
        },
        {
            "pipeline-error-cartesia-503-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCartesia503ServerError
        },
        {
            "pipeline-error-cartesia-522-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCartesia522ServerError
        },
        {
            "call.in-progress.error-vapifault-cartesia-socket-hang-up",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultCartesiaSocketHangUp
        },
        {
            "call.in-progress.error-vapifault-cartesia-requested-payment",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultCartesiaRequestedPayment
        },
        {
            "call.in-progress.error-providerfault-cartesia-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultCartesia500ServerError
        },
        {
            "call.in-progress.error-providerfault-cartesia-503-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultCartesia503ServerError
        },
        {
            "call.in-progress.error-providerfault-cartesia-522-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultCartesia522ServerError
        },
        {
            "pipeline-error-eleven-labs-voice-not-found",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsVoiceNotFound
        },
        {
            "pipeline-error-eleven-labs-quota-exceeded",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsQuotaExceeded
        },
        {
            "pipeline-error-eleven-labs-unauthorized-access",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsUnauthorizedAccess
        },
        {
            "pipeline-error-eleven-labs-unauthorized-to-access-model",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsUnauthorizedToAccessModel
        },
        {
            "pipeline-error-eleven-labs-professional-voices-only-for-creator-plus",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsProfessionalVoicesOnlyForCreatorPlus
        },
        {
            "pipeline-error-eleven-labs-blocked-free-plan-and-requested-upgrade",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsBlockedFreePlanAndRequestedUpgrade
        },
        {
            "pipeline-error-eleven-labs-blocked-concurrent-requests-and-requested-upgrade",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsBlockedConcurrentRequestsAndRequestedUpgrade
        },
        {
            "pipeline-error-eleven-labs-blocked-using-instant-voice-clone-and-requested-upgrade",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsBlockedUsingInstantVoiceCloneAndRequestedUpgrade
        },
        {
            "pipeline-error-eleven-labs-system-busy-and-requested-upgrade",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsSystemBusyAndRequestedUpgrade
        },
        {
            "pipeline-error-eleven-labs-voice-not-fine-tuned",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsVoiceNotFineTuned
        },
        {
            "pipeline-error-eleven-labs-invalid-api-key",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsInvalidApiKey
        },
        {
            "pipeline-error-eleven-labs-invalid-voice-samples",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsInvalidVoiceSamples
        },
        {
            "pipeline-error-eleven-labs-voice-disabled-by-owner",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsVoiceDisabledByOwner
        },
        {
            "pipeline-error-eleven-labs-vapi-voice-disabled-by-owner",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsVapiVoiceDisabledByOwner
        },
        {
            "pipeline-error-eleven-labs-blocked-account-in-probation",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsBlockedAccountInProbation
        },
        {
            "pipeline-error-eleven-labs-blocked-content-against-their-policy",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsBlockedContentAgainstTheirPolicy
        },
        {
            "pipeline-error-eleven-labs-missing-samples-for-voice-clone",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsMissingSamplesForVoiceClone
        },
        {
            "pipeline-error-eleven-labs-voice-not-fine-tuned-and-cannot-be-used",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsVoiceNotFineTunedAndCannotBeUsed
        },
        {
            "pipeline-error-eleven-labs-voice-not-allowed-for-free-users",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsVoiceNotAllowedForFreeUsers
        },
        {
            "pipeline-error-eleven-labs-max-character-limit-exceeded",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsMaxCharacterLimitExceeded
        },
        {
            "pipeline-error-eleven-labs-blocked-voice-potentially-against-terms-of-service-and-awaiting-verification",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabsBlockedVoicePotentiallyAgainstTermsOfServiceAndAwaitingVerification
        },
        {
            "pipeline-error-eleven-labs-500-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabs500ServerError
        },
        {
            "pipeline-error-eleven-labs-503-server-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorElevenLabs503ServerError
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-voice-not-found",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsVoiceNotFound
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-quota-exceeded",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsQuotaExceeded
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-unauthorized-access",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsUnauthorizedAccess
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-unauthorized-to-access-model",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsUnauthorizedToAccessModel
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-professional-voices-only-for-creator-plus",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsProfessionalVoicesOnlyForCreatorPlus
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-blocked-free-plan-and-requested-upgrade",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsBlockedFreePlanAndRequestedUpgrade
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-blocked-concurrent-requests-and-requested-upgrade",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsBlockedConcurrentRequestsAndRequestedUpgrade
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-blocked-using-instant-voice-clone-and-requested-upgrade",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsBlockedUsingInstantVoiceCloneAndRequestedUpgrade
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-system-busy-and-requested-upgrade",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsSystemBusyAndRequestedUpgrade
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-voice-not-fine-tuned",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsVoiceNotFineTuned
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-invalid-api-key",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsInvalidApiKey
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-invalid-voice-samples",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsInvalidVoiceSamples
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-voice-disabled-by-owner",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsVoiceDisabledByOwner
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-blocked-account-in-probation",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsBlockedAccountInProbation
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-blocked-content-against-their-policy",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsBlockedContentAgainstTheirPolicy
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-missing-samples-for-voice-clone",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsMissingSamplesForVoiceClone
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-voice-not-fine-tuned-and-cannot-be-used",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsVoiceNotFineTunedAndCannotBeUsed
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-voice-not-allowed-for-free-users",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsVoiceNotAllowedForFreeUsers
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-max-character-limit-exceeded",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsMaxCharacterLimitExceeded
        },
        {
            ...
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultElevenLabsBlockedVoicePotentiallyAgainstTermsOfServiceAndAwaitingVerification
        },
        {
            "call.in-progress.error-providerfault-eleven-labs-system-busy-and-requested-upgrade",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultElevenLabsSystemBusyAndRequestedUpgrade
        },
        {
            "call.in-progress.error-providerfault-eleven-labs-500-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultElevenLabs500ServerError
        },
        {
            "call.in-progress.error-providerfault-eleven-labs-503-server-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultElevenLabs503ServerError
        },
        {
            "pipeline-error-playht-request-timed-out",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorPlayhtRequestTimedOut
        },
        {
            "pipeline-error-playht-invalid-voice",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorPlayhtInvalidVoice
        },
        {
            "pipeline-error-playht-unexpected-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorPlayhtUnexpectedError
        },
        {
            "pipeline-error-playht-out-of-credits",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorPlayhtOutOfCredits
        },
        {
            "pipeline-error-playht-invalid-emotion",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorPlayhtInvalidEmotion
        },
        {
            "pipeline-error-playht-voice-must-be-a-valid-voice-manifest-uri",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorPlayhtVoiceMustBeAValidVoiceManifestUri
        },
        {
            "pipeline-error-playht-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorPlayht401Unauthorized
        },
        {
            "pipeline-error-playht-403-forbidden-out-of-characters",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorPlayht403ForbiddenOutOfCharacters
        },
        {
            "pipeline-error-playht-403-forbidden-api-access-not-available",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorPlayht403ForbiddenApiAccessNotAvailable
        },
        {
            "pipeline-error-playht-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorPlayht429ExceededQuota
        },
        {
            "pipeline-error-playht-502-gateway-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorPlayht502GatewayError
        },
        {
            "pipeline-error-playht-504-gateway-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorPlayht504GatewayError
        },
        {
            "call.in-progress.error-vapifault-playht-request-timed-out",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultPlayhtRequestTimedOut
        },
        {
            "call.in-progress.error-vapifault-playht-invalid-voice",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultPlayhtInvalidVoice
        },
        {
            "call.in-progress.error-vapifault-playht-unexpected-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultPlayhtUnexpectedError
        },
        {
            "call.in-progress.error-vapifault-playht-out-of-credits",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultPlayhtOutOfCredits
        },
        {
            "call.in-progress.error-vapifault-playht-invalid-emotion",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultPlayhtInvalidEmotion
        },
        {
            "call.in-progress.error-vapifault-playht-voice-must-be-a-valid-voice-manifest-uri",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultPlayhtVoiceMustBeAValidVoiceManifestUri
        },
        {
            "call.in-progress.error-vapifault-playht-401-unauthorized",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultPlayht401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-playht-403-forbidden-out-of-characters",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultPlayht403ForbiddenOutOfCharacters
        },
        {
            "call.in-progress.error-vapifault-playht-403-forbidden-api-access-not-available",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultPlayht403ForbiddenApiAccessNotAvailable
        },
        {
            "call.in-progress.error-vapifault-playht-429-exceeded-quota",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultPlayht429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-playht-502-gateway-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultPlayht502GatewayError
        },
        {
            "call.in-progress.error-providerfault-playht-504-gateway-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultPlayht504GatewayError
        },
        {
            "pipeline-error-custom-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorCustomTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-custom-transcriber-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultCustomTranscriberFailed
        },
        {
            "pipeline-error-deepgram-returning-400-no-such-model-language-tier-combination",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepgramReturning400NoSuchModelLanguageTierCombination
        },
        {
            "pipeline-error-deepgram-returning-401-invalid-credentials",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepgramReturning401InvalidCredentials
        },
        {
            "pipeline-error-deepgram-returning-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepgramReturning403ModelAccessDenied
        },
        {
            "pipeline-error-deepgram-returning-404-not-found",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepgramReturning404NotFound
        },
        {
            "pipeline-error-deepgram-returning-500-invalid-json",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepgramReturning500InvalidJson
        },
        {
            "pipeline-error-deepgram-returning-502-network-error",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepgramReturning502NetworkError
        },
        {
            "pipeline-error-deepgram-returning-502-bad-gateway-ehostunreach",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepgramReturning502BadGatewayEhostunreach
        },
        {
            "pipeline-error-deepgram-returning-econnreset",
            ServerMessageEndOfCallReportEndedReason.PipelineErrorDeepgramReturningEconnreset
        },
        {
            "call.in-progress.error-vapifault-deepgram-returning-400-no-such-model-language-tier-combination",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultDeepgramReturning400NoSuchModelLanguageTierCombination
        },
        {
            "call.in-progress.error-vapifault-deepgram-returning-401-invalid-credentials",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultDeepgramReturning401InvalidCredentials
        },
        {
            "call.in-progress.error-vapifault-deepgram-returning-404-not-found",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultDeepgramReturning404NotFound
        },
        {
            "call.in-progress.error-vapifault-deepgram-returning-403-model-access-denied",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorVapifaultDeepgramReturning403ModelAccessDenied
        },
        {
            "call.in-progress.error-providerfault-deepgram-returning-500-invalid-json",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultDeepgramReturning500InvalidJson
        },
        {
            "call.in-progress.error-providerfault-deepgram-returning-502-network-error",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultDeepgramReturning502NetworkError
        },
        {
            "call.in-progress.error-providerfault-deepgram-returning-502-bad-gateway-ehostunreach",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultDeepgramReturning502BadGatewayEhostunreach
        },
        {
            "call.in-progress.error-warm-transfer-max-duration",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorWarmTransferMaxDuration
        },
        {
            "call.in-progress.error-warm-transfer-assistant-cancelled",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorWarmTransferAssistantCancelled
        },
        {
            "call.in-progress.error-warm-transfer-silence-timeout",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorWarmTransferSilenceTimeout
        },
        {
            "call.in-progress.error-warm-transfer-microphone-timeout",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorWarmTransferMicrophoneTimeout
        },
        { "assistant-ended-call", ServerMessageEndOfCallReportEndedReason.AssistantEndedCall },
        {
            "assistant-said-end-call-phrase",
            ServerMessageEndOfCallReportEndedReason.AssistantSaidEndCallPhrase
        },
        {
            "assistant-ended-call-with-hangup-task",
            ServerMessageEndOfCallReportEndedReason.AssistantEndedCallWithHangupTask
        },
        {
            "assistant-ended-call-after-message-spoken",
            ServerMessageEndOfCallReportEndedReason.AssistantEndedCallAfterMessageSpoken
        },
        {
            "assistant-forwarded-call",
            ServerMessageEndOfCallReportEndedReason.AssistantForwardedCall
        },
        {
            "assistant-join-timed-out",
            ServerMessageEndOfCallReportEndedReason.AssistantJoinTimedOut
        },
        {
            "call.in-progress.error-assistant-did-not-receive-customer-audio",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorAssistantDidNotReceiveCustomerAudio
        },
        {
            "call.in-progress.error-transfer-failed",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorTransferFailed
        },
        ...
        { "customer-ended-call", ServerMessageEndOfCallReportEndedReason.CustomerEndedCall },
        {
            ...
            ServerMessageEndOfCallReportEndedReason.CustomerEndedCallBeforeWarmTransfer
        },
        {
            "customer-ended-call-after-warm-transfer-attempt",
            ServerMessageEndOfCallReportEndedReason.CustomerEndedCallAfterWarmTransferAttempt
        },
        {
            "customer-ended-call-during-transfer",
            ServerMessageEndOfCallReportEndedReason.CustomerEndedCallDuringTransfer
        },
        { "customer-did-not-answer", ServerMessageEndOfCallReportEndedReason.CustomerDidNotAnswer },
        {
            "customer-did-not-give-microphone-permission",
            ServerMessageEndOfCallReportEndedReason.CustomerDidNotGiveMicrophonePermission
        },
        ...
        { "manually-canceled", ServerMessageEndOfCallReportEndedReason.ManuallyCanceled },
        {
            ...
            ServerMessageEndOfCallReportEndedReason.PhoneCallProviderClosedWebsocket
        },
        {
            "call.forwarding.operator-busy",
            ServerMessageEndOfCallReportEndedReason.CallForwardingOperatorBusy
        },
        {
            "call.forwarding.no-answer",
            ServerMessageEndOfCallReportEndedReason.CallForwardingNoAnswer
        },
        { "silence-timed-out", ServerMessageEndOfCallReportEndedReason.SilenceTimedOut },
        {
            ...
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultOutboundSip403Forbidden
        },
        {
            "call.in-progress.error-providerfault-outbound-sip-407-proxy-authentication-required",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultOutboundSip407ProxyAuthenticationRequired
        },
        {
            "call.in-progress.error-providerfault-outbound-sip-408-request-timeout",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultOutboundSip408RequestTimeout
        },
        {
            "call.in-progress.error-providerfault-outbound-sip-480-temporarily-unavailable",
            ServerMessageEndOfCallReportEndedReason.CallInProgressErrorProviderfaultOutboundSip480TemporarilyUnavailable
        },
        {
            "sip-outbound-unallocated-number",
            ServerMessageEndOfCallReportEndedReason.SipOutboundUnallocatedNumber
        },
        {
            "sip-outbound-carrier-released-call",
            ServerMessageEndOfCallReportEndedReason.SipOutboundCarrierReleasedCall
        },
        {
            "call.ringing.hook-executed-say",
            ServerMessageEndOfCallReportEndedReason.CallRingingHookExecutedSay
        },
        {
            "call.ringing.hook-executed-transfer",
            ServerMessageEndOfCallReportEndedReason.CallRingingHookExecutedTransfer
        },
        {
            "call.ending.hook-executed-say",
            ServerMessageEndOfCallReportEndedReason.CallEndingHookExecutedSay
        },
        {
            "call.ending.hook-executed-transfer",
            ServerMessageEndOfCallReportEndedReason.CallEndingHookExecutedTransfer
        },
        {
            "call.ringing.sip-inbound-caller-hungup-before-call-connect",
            ServerMessageEndOfCallReportEndedReason.CallRingingSipInboundCallerHungupBeforeCallConnect
        },
        {
            "twilio-failed-to-connect-call",
            ServerMessageEndOfCallReportEndedReason.TwilioFailedToConnectCall
        },
        {
            "twilio-reported-customer-misdialed",
            ServerMessageEndOfCallReportEndedReason.TwilioReportedCustomerMisdialed
        },
    ...
    public override ServerMessageEndOfCallReportEndedReason Read(
    ...
    public override void Write(
        ...
        ServerMessageEndOfCallReportEndedReason value,
        global::System.Text.Json.JsonSerializerOptions options
    )
    {
    ...
    public override ServerMessageEndOfCallReportEndedReason ReadAsPropertyName(
        ref global::System.Text.Json.Utf8JsonReader reader,
        global::System.Type typeToConvert,
        global::System.Text.Json.JsonSerializerOptions options
    )

    ...
    : global::System.Text.Json.Serialization.JsonConverter<CreateAzureOpenAiCredentialDtoModelsItem>
{
    ...
    > _stringToEnum = new()
    {
        { "gpt-5.6-luna-2026-07-09", CreateAzureOpenAiCredentialDtoModelsItem.Gpt56Luna20260709 },
        { "gpt-5.6-terra-2026-07-09", CreateAzureOpenAiCredentialDtoModelsItem.Gpt56Terra20260709 },
        { "gpt-5.6-sol-2026-07-09", CreateAzureOpenAiCredentialDtoModelsItem.Gpt56Sol20260709 },
        ...
        { "gpt-4o", CreateAzureOpenAiCredentialDtoModelsItem.Gpt4O },
        { "gpt-4.1", CreateAzureOpenAiCredentialDtoModelsItem.Gpt41 },
        { "gpt-5.4-mini-2026-03-17", CreateAzureOpenAiCredentialDtoModelsItem.Gpt54Mini20260317 },
    };
    ...
    > _enumToString = new()
    {
        { CreateAzureOpenAiCredentialDtoModelsItem.Gpt56Luna20260709, "gpt-5.6-luna-2026-07-09" },
        { CreateAzureOpenAiCredentialDtoModelsItem.Gpt56Terra20260709, "gpt-5.6-terra-2026-07-09" },
        { CreateAzureOpenAiCredentialDtoModelsItem.Gpt56Sol20260709, "gpt-5.6-sol-2026-07-09" },
        ...
        { CreateAzureOpenAiCredentialDtoModelsItem.Gpt4O, "gpt-4o" },
        { CreateAzureOpenAiCredentialDtoModelsItem.Gpt41, "gpt-4.1" },
        { CreateAzureOpenAiCredentialDtoModelsItem.Gpt54Mini20260317, "gpt-5.4-mini-2026-03-17" },
    };

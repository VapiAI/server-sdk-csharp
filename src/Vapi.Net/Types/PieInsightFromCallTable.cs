...
[Serializable]
public record PieInsightFromCallTable : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PieInsightFromCallTableType Type { get; set; }
    ...
    public PieInsightFromCallTableGroupBy? GroupBy { get; set; }

...
[Serializable]
public record ComputerToolWithToolCall : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required ComputerToolWithToolCallSubType SubType { get; set; }
    ...
    public required ComputerToolWithToolCallName Name { get; set; }

...
[Serializable]
public record FallbackInworldVoice : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required FallbackInworldVoiceVoiceId VoiceId { get; set; }
    ...
    public FallbackInworldVoiceLanguageCode? LanguageCode { get; set; }

...
[Serializable]
public record CampaignSummary : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required CampaignSummaryStatus Status { get; set; }

    /// <summary>
    /// This is the explanation for how the campaign ended.
    /// </summary>
    [JsonPropertyName("endedReason")]
    public CampaignSummaryEndedReason? EndedReason { get; set; }
    ...
    public IEnumerable<CampaignSummaryServerMessagesItem>? ServerMessages { get; set; }
    ...
    /// complete.
    /// </summary>
    [JsonPropertyName("contactCounters")]
    public CampaignContactCounters? ContactCounters { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("callMetrics")]
    public CampaignCallMetrics? CallMetrics { get; set; }

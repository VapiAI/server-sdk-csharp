...
[Serializable]
public record LineInsightFromCallTable : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required LineInsightFromCallTableType Type { get; set; }
    ...
    public LineInsightFromCallTableGroupBy? GroupBy { get; set; }

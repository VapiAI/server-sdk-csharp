...
[Serializable]
public record UpdateToolDraftDto : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public UpdateToolDraftDtoType? Type { get; set; }
    ...
    public UpdateToolDraftDtoMethod? Method { get; set; }
    ...
    public UpdateToolDraftDtoVerb? Verb { get; set; }

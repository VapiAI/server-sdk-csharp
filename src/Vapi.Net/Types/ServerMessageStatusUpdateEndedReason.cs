...
[JsonConverter(typeof(ServerMessageStatusUpdateEndedReasonSerializer))]
...
internal class ServerMessageStatusUpdateEndedReasonSerializer
    : global::System.Text.Json.Serialization.JsonConverter<ServerMessageStatusUpdateEndedReason>
{
    ...
    {
        {
            ...
            ServerMessageStatusUpdateEndedReason.CallStartErrorNeitherAssistantNorServerSet
        },
        { "assistant-request-failed", ServerMessageStatusUpdateEndedReason.AssistantRequestFailed },
        {
            "assistant-request-returned-error",
            ServerMessageStatusUpdateEndedReason.AssistantRequestReturnedError
        },
        {
            "assistant-request-returned-unspeakable-error",
            ServerMessageStatusUpdateEndedReason.AssistantRequestReturnedUnspeakableError
        },
        {
            "assistant-request-returned-invalid-assistant",
            ServerMessageStatusUpdateEndedReason.AssistantRequestReturnedInvalidAssistant
        },
        {
            "assistant-request-returned-no-assistant",
            ServerMessageStatusUpdateEndedReason.AssistantRequestReturnedNoAssistant
        },
        {
            "assistant-request-returned-forwarding-phone-number",
            ServerMessageStatusUpdateEndedReason.AssistantRequestReturnedForwardingPhoneNumber
        },
        { "scheduled-call-deleted", ServerMessageStatusUpdateEndedReason.ScheduledCallDeleted },
        {
            "call.start.error-vapifault-get-org",
            ServerMessageStatusUpdateEndedReason.CallStartErrorVapifaultGetOrg
        },
        {
            "call.start.error-vapifault-get-subscription",
            ServerMessageStatusUpdateEndedReason.CallStartErrorVapifaultGetSubscription
        },
        {
            "call.start.error-get-assistant",
            ServerMessageStatusUpdateEndedReason.CallStartErrorGetAssistant
        },
        {
            "call.start.error-get-phone-number",
            ServerMessageStatusUpdateEndedReason.CallStartErrorGetPhoneNumber
        },
        {
            "call.start.error-get-customer",
            ServerMessageStatusUpdateEndedReason.CallStartErrorGetCustomer
        },
        {
            "call.start.error-get-resources-validation",
            ServerMessageStatusUpdateEndedReason.CallStartErrorGetResourcesValidation
        },
        {
            "call.start.error-vapi-number-international",
            ServerMessageStatusUpdateEndedReason.CallStartErrorVapiNumberInternational
        },
        {
            "call.start.error-vapi-number-outbound-daily-limit",
            ServerMessageStatusUpdateEndedReason.CallStartErrorVapiNumberOutboundDailyLimit
        },
        {
            "call.start.error-get-transport",
            ServerMessageStatusUpdateEndedReason.CallStartErrorGetTransport
        },
        {
            "call.start.error-subscription-wallet-does-not-exist",
            ServerMessageStatusUpdateEndedReason.CallStartErrorSubscriptionWalletDoesNotExist
        },
        {
            "call.start.error-fraud-check-failed",
            ServerMessageStatusUpdateEndedReason.CallStartErrorFraudCheckFailed
        },
        {
            "call.start.error-subscription-frozen",
            ServerMessageStatusUpdateEndedReason.CallStartErrorSubscriptionFrozen
        },
        {
            "call.start.error-subscription-insufficient-credits",
            ServerMessageStatusUpdateEndedReason.CallStartErrorSubscriptionInsufficientCredits
        },
        {
            "call.start.error-subscription-upgrade-failed",
            ServerMessageStatusUpdateEndedReason.CallStartErrorSubscriptionUpgradeFailed
        },
        {
            "call.start.error-subscription-concurrency-limit-reached",
            ServerMessageStatusUpdateEndedReason.CallStartErrorSubscriptionConcurrencyLimitReached
        },
        {
        ...
        },
        {
            ...
            ServerMessageStatusUpdateEndedReason.CallStartSquadVersionErrorValidation
        },
        ...
        { "assistant-not-found", ServerMessageStatusUpdateEndedReason.AssistantNotFound },
        {
            ...
            ServerMessageStatusUpdateEndedReason.PipelineErrorOpenaiVoiceFailed
        },
        {
            "pipeline-error-cartesia-voice-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCartesiaVoiceFailed
        },
        {
            "pipeline-error-deepgram-voice-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepgramVoiceFailed
        },
        {
            "pipeline-error-eleven-labs-voice-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsVoiceFailed
        },
        {
            "pipeline-error-playht-voice-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorPlayhtVoiceFailed
        },
        {
            "pipeline-error-lmnt-voice-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorLmntVoiceFailed
        },
        {
            "pipeline-error-azure-voice-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAzureVoiceFailed
        },
        {
            "pipeline-error-rime-ai-voice-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorRimeAiVoiceFailed
        },
        {
            "pipeline-error-smallest-ai-voice-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorSmallestAiVoiceFailed
        },
        {
            "pipeline-error-vapi-voice-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorVapiVoiceFailed
        },
        {
            "pipeline-error-neuphonic-voice-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorNeuphonicVoiceFailed
        },
        {
            "pipeline-error-hume-voice-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorHumeVoiceFailed
        },
        {
            "pipeline-error-sesame-voice-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorSesameVoiceFailed
        },
        {
            "pipeline-error-inworld-voice-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorInworldVoiceFailed
        },
        {
            "pipeline-error-minimax-voice-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorMinimaxVoiceFailed
        },
        {
        ...
        },
        {
            ...
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultOpenaiVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-cartesia-voice-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultCartesiaVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-deepgram-voice-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultDeepgramVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-voice-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-playht-voice-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultPlayhtVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-lmnt-voice-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultLmntVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-azure-voice-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAzureVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-rime-ai-voice-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultRimeAiVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-smallest-ai-voice-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultSmallestAiVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-vapi-voice-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultVapiVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-neuphonic-voice-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultNeuphonicVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-hume-voice-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultHumeVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-sesame-voice-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultSesameVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-inworld-voice-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultInworldVoiceFailed
        },
        {
            "call.in-progress.error-vapifault-minimax-voice-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultMinimaxVoiceFailed
        },
        {
        ...
        },
        {
            ...
            ServerMessageStatusUpdateEndedReason.PipelineErrorVapiLlmFailed
        },
        {
            "pipeline-error-vapi-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorVapi400BadRequestValidationFailed
        },
        {
            "pipeline-error-vapi-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorVapi401Unauthorized
        },
        {
            "pipeline-error-vapi-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorVapi403ModelAccessDenied
        },
        {
            "pipeline-error-vapi-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorVapi429ExceededQuota
        },
        {
            "pipeline-error-vapi-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorVapi500ServerError
        },
        {
            "pipeline-error-vapi-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorVapi503ServerOverloadedError
        },
        {
        ...
        },
        {
            ...
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultVapi401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-vapi-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultVapi403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-vapi-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultVapi429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-vapi-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultVapi500ServerError
        },
        {
        ...
        },
        {
            ...
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepgramTranscriberApiKeyMissing
        },
        {
            "call.in-progress.error-vapifault-deepgram-transcriber-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultDeepgramTranscriberFailed
        },
        {
            "pipeline-error-gladia-transcriber-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorGladiaTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-gladia-transcriber-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultGladiaTranscriberFailed
        },
        {
            "pipeline-error-speechmatics-transcriber-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorSpeechmaticsTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-speechmatics-transcriber-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultSpeechmaticsTranscriberFailed
        },
        {
            "pipeline-error-assembly-ai-transcriber-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAssemblyAiTranscriberFailed
        },
        {
            "pipeline-error-assembly-ai-returning-400-insufficent-funds",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAssemblyAiReturning400InsufficentFunds
        },
        {
            "pipeline-error-assembly-ai-returning-400-paid-only-feature",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAssemblyAiReturning400PaidOnlyFeature
        },
        {
            "pipeline-error-assembly-ai-returning-401-invalid-credentials",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAssemblyAiReturning401InvalidCredentials
        },
        {
            "pipeline-error-assembly-ai-returning-500-invalid-schema",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAssemblyAiReturning500InvalidSchema
        },
        {
            "pipeline-error-assembly-ai-returning-500-word-boost-parsing-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAssemblyAiReturning500WordBoostParsingFailed
        },
        {
            "call.in-progress.error-vapifault-assembly-ai-transcriber-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAssemblyAiTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-assembly-ai-returning-400-insufficent-funds",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAssemblyAiReturning400InsufficentFunds
        },
        {
            "call.in-progress.error-vapifault-assembly-ai-returning-400-paid-only-feature",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAssemblyAiReturning400PaidOnlyFeature
        },
        {
            "call.in-progress.error-vapifault-assembly-ai-returning-401-invalid-credentials",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAssemblyAiReturning401InvalidCredentials
        },
        {
            "call.in-progress.error-vapifault-assembly-ai-returning-500-invalid-schema",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAssemblyAiReturning500InvalidSchema
        },
        {
            "call.in-progress.error-vapifault-assembly-ai-returning-500-word-boost-parsing-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAssemblyAiReturning500WordBoostParsingFailed
        },
        {
            "pipeline-error-talkscriber-transcriber-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorTalkscriberTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-talkscriber-transcriber-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultTalkscriberTranscriberFailed
        },
        {
            "pipeline-error-azure-speech-transcriber-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAzureSpeechTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-azure-speech-transcriber-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAzureSpeechTranscriberFailed
        },
        {
            "pipeline-error-eleven-labs-transcriber-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-transcriber-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsTranscriberFailed
        },
        {
            "pipeline-error-google-transcriber-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorGoogleTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-google-transcriber-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultGoogleTranscriberFailed
        },
        {
            "pipeline-error-openai-transcriber-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorOpenaiTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-openai-transcriber-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultOpenaiTranscriberFailed
        },
        {
            "pipeline-error-soniox-transcriber-auth-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorSonioxTranscriberAuthFailed
        },
        {
            "pipeline-error-soniox-transcriber-rate-limited",
            ServerMessageStatusUpdateEndedReason.PipelineErrorSonioxTranscriberRateLimited
        },
        {
            "pipeline-error-soniox-transcriber-invalid-config",
            ServerMessageStatusUpdateEndedReason.PipelineErrorSonioxTranscriberInvalidConfig
        },
        {
            "pipeline-error-soniox-transcriber-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorSonioxTranscriberServerError
        },
        {
            "pipeline-error-soniox-transcriber-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorSonioxTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-soniox-transcriber-auth-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultSonioxTranscriberAuthFailed
        },
        {
            "call.in-progress.error-vapifault-soniox-transcriber-rate-limited",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultSonioxTranscriberRateLimited
        },
        {
            "call.in-progress.error-vapifault-soniox-transcriber-invalid-config",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultSonioxTranscriberInvalidConfig
        },
        {
            "call.in-progress.error-vapifault-soniox-transcriber-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultSonioxTranscriberServerError
        },
        {
        ...
        { "vonage-disconnected", ServerMessageStatusUpdateEndedReason.VonageDisconnected },
        {
            ...
            ServerMessageStatusUpdateEndedReason.VonageFailedToConnectCall
        },
        { "vonage-completed", ServerMessageStatusUpdateEndedReason.VonageCompleted },
        {
            "phone-call-provider-bypass-enabled-but-no-call-received",
            ServerMessageStatusUpdateEndedReason.PhoneCallProviderBypassEnabledButNoCallReceived
        },
        {
            "call.in-progress.error-providerfault-transport-never-connected",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultTransportNeverConnected
        },
        {
            "call.in-progress.error-vapifault-worker-not-available",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultWorkerNotAvailable
        },
        {
            "call.in-progress.error-vapifault-transport-never-connected",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultTransportNeverConnected
        },
        {
            "call.in-progress.error-vapifault-transport-connected-but-call-not-active",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultTransportConnectedButCallNotActive
        },
        {
        ...
        },
        {
            ...
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultWorkerDied
        },
        {
            "call.in-progress.twilio-completed-call",
            ServerMessageStatusUpdateEndedReason.CallInProgressTwilioCompletedCall
        },
        {
            "call.in-progress.sip-completed-call",
            ServerMessageStatusUpdateEndedReason.CallInProgressSipCompletedCall
        },
        {
            "call.in-progress.error-sip-inbound-call-failed-to-connect",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorSipInboundCallFailedToConnect
        },
        {
            "call.in-progress.error-providerfault-outbound-sip-503-service-unavailable",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultOutboundSip503ServiceUnavailable
        },
        {
            "call.in-progress.error-sip-outbound-call-failed-to-connect",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorSipOutboundCallFailedToConnect
        },
        {
            "call.ringing.error-sip-inbound-call-failed-to-connect",
            ServerMessageStatusUpdateEndedReason.CallRingingErrorSipInboundCallFailedToConnect
        },
        {
            "call.in-progress.error-providerfault-openai-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultOpenaiLlmFailed
        },
        {
            "call.in-progress.error-providerfault-azure-openai-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultAzureOpenaiLlmFailed
        },
        {
            "call.in-progress.error-providerfault-groq-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultGroqLlmFailed
        },
        {
            "call.in-progress.error-providerfault-google-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultGoogleLlmFailed
        },
        {
            "call.in-progress.error-providerfault-xai-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultXaiLlmFailed
        },
        {
            "call.in-progress.error-providerfault-mistral-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultMistralLlmFailed
        },
        {
            "call.in-progress.error-providerfault-minimax-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultMinimaxLlmFailed
        },
        {
            "call.in-progress.error-providerfault-inflection-ai-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultInflectionAiLlmFailed
        },
        {
            "call.in-progress.error-providerfault-cerebras-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultCerebrasLlmFailed
        },
        {
            "call.in-progress.error-providerfault-deep-seek-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultDeepSeekLlmFailed
        },
        {
            "call.in-progress.error-providerfault-baseten-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultBasetenLlmFailed
        },
        {
        ...
        },
        {
            ...
            ServerMessageStatusUpdateEndedReason.PipelineErrorOpenai401Unauthorized
        },
        {
            "pipeline-error-openai-401-incorrect-api-key",
            ServerMessageStatusUpdateEndedReason.PipelineErrorOpenai401IncorrectApiKey
        },
        {
            "pipeline-error-openai-401-account-not-in-organization",
            ServerMessageStatusUpdateEndedReason.PipelineErrorOpenai401AccountNotInOrganization
        },
        {
            "pipeline-error-openai-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorOpenai403ModelAccessDenied
        },
        {
            "pipeline-error-openai-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorOpenai429ExceededQuota
        },
        {
            "pipeline-error-openai-429-rate-limit-reached",
            ServerMessageStatusUpdateEndedReason.PipelineErrorOpenai429RateLimitReached
        },
        {
            "pipeline-error-openai-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorOpenai500ServerError
        },
        {
            "pipeline-error-openai-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorOpenai503ServerOverloadedError
        },
        {
            "pipeline-error-openai-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorOpenaiLlmFailed
        },
        {
            "call.in-progress.error-vapifault-openai-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultOpenai400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-openai-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultOpenai401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-openai-401-incorrect-api-key",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultOpenai401IncorrectApiKey
        },
        {
            "call.in-progress.error-vapifault-openai-401-account-not-in-organization",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultOpenai401AccountNotInOrganization
        },
        {
            "call.in-progress.error-vapifault-openai-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultOpenai403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-openai-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultOpenai429ExceededQuota
        },
        {
            "call.in-progress.error-vapifault-openai-429-rate-limit-reached",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultOpenai429RateLimitReached
        },
        {
            "call.in-progress.error-providerfault-openai-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultOpenai500ServerError
        },
        {
            "call.in-progress.error-providerfault-openai-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultOpenai503ServerOverloadedError
        },
        {
            "pipeline-error-azure-openai-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAzureOpenai400BadRequestValidationFailed
        },
        {
            "pipeline-error-azure-openai-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAzureOpenai401Unauthorized
        },
        {
            "pipeline-error-azure-openai-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAzureOpenai403ModelAccessDenied
        },
        {
            "pipeline-error-azure-openai-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAzureOpenai429ExceededQuota
        },
        {
            "pipeline-error-azure-openai-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAzureOpenai500ServerError
        },
        {
            "pipeline-error-azure-openai-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAzureOpenai503ServerOverloadedError
        },
        {
            "pipeline-error-azure-openai-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAzureOpenaiLlmFailed
        },
        {
            "call.in-progress.error-vapifault-azure-openai-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAzureOpenai400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-azure-openai-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAzureOpenai401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-azure-openai-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAzureOpenai403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-azure-openai-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAzureOpenai429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-azure-openai-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultAzureOpenai500ServerError
        },
        {
            "call.in-progress.error-providerfault-azure-openai-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultAzureOpenai503ServerOverloadedError
        },
        {
            "pipeline-error-google-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorGoogle400BadRequestValidationFailed
        },
        {
            "pipeline-error-google-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorGoogle401Unauthorized
        },
        {
            "pipeline-error-google-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorGoogle403ModelAccessDenied
        },
        {
            "pipeline-error-google-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorGoogle429ExceededQuota
        },
        {
            "pipeline-error-google-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorGoogle500ServerError
        },
        {
            "pipeline-error-google-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorGoogle503ServerOverloadedError
        },
        {
            "pipeline-error-google-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorGoogleLlmFailed
        },
        {
            "call.in-progress.error-vapifault-google-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultGoogle400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-google-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultGoogle401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-google-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultGoogle403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-google-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultGoogle429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-google-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultGoogle500ServerError
        },
        {
            "call.in-progress.error-providerfault-google-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultGoogle503ServerOverloadedError
        },
        {
            "pipeline-error-xai-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorXai400BadRequestValidationFailed
        },
        {
            "pipeline-error-xai-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorXai401Unauthorized
        },
        {
            "pipeline-error-xai-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorXai403ModelAccessDenied
        },
        {
            "pipeline-error-xai-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorXai429ExceededQuota
        },
        {
            "pipeline-error-xai-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorXai500ServerError
        },
        {
            "pipeline-error-xai-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorXai503ServerOverloadedError
        },
        {
            "pipeline-error-xai-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorXaiLlmFailed
        },
        {
            "call.in-progress.error-vapifault-xai-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultXai400BadRequestValidationFailed
        },
        {
        ...
        },
        {
            ...
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultXai403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-xai-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultXai429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-xai-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultXai500ServerError
        },
        {
            "call.in-progress.error-providerfault-xai-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultXai503ServerOverloadedError
        },
        {
            "pipeline-error-baseten-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorBaseten400BadRequestValidationFailed
        },
        {
            "pipeline-error-baseten-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorBaseten401Unauthorized
        },
        {
            "pipeline-error-baseten-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorBaseten403ModelAccessDenied
        },
        {
            "pipeline-error-baseten-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorBaseten429ExceededQuota
        },
        {
            "pipeline-error-baseten-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorBaseten500ServerError
        },
        {
            "pipeline-error-baseten-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorBaseten503ServerOverloadedError
        },
        {
            "pipeline-error-baseten-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorBasetenLlmFailed
        },
        {
            "call.in-progress.error-vapifault-baseten-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultBaseten400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-baseten-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultBaseten401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-baseten-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultBaseten403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-baseten-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultBaseten429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-baseten-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultBaseten500ServerError
        },
        {
            "call.in-progress.error-providerfault-baseten-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultBaseten503ServerOverloadedError
        },
        {
            "pipeline-error-mistral-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorMistral400BadRequestValidationFailed
        },
        {
            "pipeline-error-mistral-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorMistral401Unauthorized
        },
        {
            "pipeline-error-mistral-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorMistral403ModelAccessDenied
        },
        {
            "pipeline-error-mistral-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorMistral429ExceededQuota
        },
        {
            "pipeline-error-mistral-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorMistral500ServerError
        },
        {
            "pipeline-error-mistral-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorMistral503ServerOverloadedError
        },
        {
            "pipeline-error-mistral-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorMistralLlmFailed
        },
        {
            "call.in-progress.error-vapifault-mistral-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultMistral400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-mistral-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultMistral401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-mistral-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultMistral403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-mistral-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultMistral429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-mistral-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultMistral500ServerError
        },
        {
            "call.in-progress.error-providerfault-mistral-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultMistral503ServerOverloadedError
        },
        {
            "pipeline-error-minimax-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorMinimax400BadRequestValidationFailed
        },
        {
            "pipeline-error-minimax-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorMinimax401Unauthorized
        },
        {
            "pipeline-error-minimax-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorMinimax403ModelAccessDenied
        },
        {
            "pipeline-error-minimax-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorMinimax429ExceededQuota
        },
        {
            "pipeline-error-minimax-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorMinimax500ServerError
        },
        {
            "pipeline-error-minimax-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorMinimax503ServerOverloadedError
        },
        {
            "pipeline-error-minimax-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorMinimaxLlmFailed
        },
        {
            "call.in-progress.error-vapifault-minimax-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultMinimax400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-minimax-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultMinimax401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-minimax-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultMinimax403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-minimax-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultMinimax429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-minimax-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultMinimax500ServerError
        },
        {
            "call.in-progress.error-providerfault-minimax-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultMinimax503ServerOverloadedError
        },
        {
            "pipeline-error-inflection-ai-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorInflectionAi400BadRequestValidationFailed
        },
        {
            "pipeline-error-inflection-ai-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorInflectionAi401Unauthorized
        },
        {
            "pipeline-error-inflection-ai-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorInflectionAi403ModelAccessDenied
        },
        {
            "pipeline-error-inflection-ai-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorInflectionAi429ExceededQuota
        },
        {
            "pipeline-error-inflection-ai-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorInflectionAi500ServerError
        },
        {
            "pipeline-error-inflection-ai-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorInflectionAi503ServerOverloadedError
        },
        {
            "pipeline-error-inflection-ai-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorInflectionAiLlmFailed
        },
        {
            "call.in-progress.error-vapifault-inflection-ai-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultInflectionAi400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-inflection-ai-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultInflectionAi401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-inflection-ai-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultInflectionAi403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-inflection-ai-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultInflectionAi429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-inflection-ai-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultInflectionAi500ServerError
        },
        {
            "call.in-progress.error-providerfault-inflection-ai-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultInflectionAi503ServerOverloadedError
        },
        {
            "pipeline-error-deep-seek-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepSeek400BadRequestValidationFailed
        },
        {
            "pipeline-error-deep-seek-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepSeek401Unauthorized
        },
        {
            "pipeline-error-deep-seek-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepSeek403ModelAccessDenied
        },
        {
            "pipeline-error-deep-seek-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepSeek429ExceededQuota
        },
        {
            "pipeline-error-deep-seek-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepSeek500ServerError
        },
        {
            "pipeline-error-deep-seek-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepSeek503ServerOverloadedError
        },
        {
            "pipeline-error-deep-seek-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepSeekLlmFailed
        },
        {
            "call.in-progress.error-vapifault-deep-seek-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultDeepSeek400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-deep-seek-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultDeepSeek401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-deep-seek-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultDeepSeek403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-deep-seek-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultDeepSeek429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-deep-seek-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultDeepSeek500ServerError
        },
        {
            "call.in-progress.error-providerfault-deep-seek-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultDeepSeek503ServerOverloadedError
        },
        {
            "pipeline-error-groq-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorGroq400BadRequestValidationFailed
        },
        {
            "pipeline-error-groq-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorGroq401Unauthorized
        },
        {
            "pipeline-error-groq-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorGroq403ModelAccessDenied
        },
        {
            "pipeline-error-groq-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorGroq429ExceededQuota
        },
        {
            "pipeline-error-groq-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorGroq500ServerError
        },
        {
            "pipeline-error-groq-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorGroq503ServerOverloadedError
        },
        {
            "pipeline-error-groq-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorGroqLlmFailed
        },
        {
            "call.in-progress.error-vapifault-groq-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultGroq400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-groq-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultGroq401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-groq-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultGroq403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-groq-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultGroq429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-groq-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultGroq500ServerError
        },
        {
            "call.in-progress.error-providerfault-groq-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultGroq503ServerOverloadedError
        },
        {
            "pipeline-error-cerebras-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCerebras400BadRequestValidationFailed
        },
        {
            "pipeline-error-cerebras-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCerebras401Unauthorized
        },
        {
            "pipeline-error-cerebras-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCerebras403ModelAccessDenied
        },
        {
            "pipeline-error-cerebras-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCerebras429ExceededQuota
        },
        {
            "pipeline-error-cerebras-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCerebras500ServerError
        },
        {
            "pipeline-error-cerebras-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCerebras503ServerOverloadedError
        },
        {
            "pipeline-error-cerebras-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCerebrasLlmFailed
        },
        {
            "call.in-progress.error-vapifault-cerebras-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultCerebras400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-cerebras-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultCerebras401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-cerebras-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultCerebras403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-cerebras-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultCerebras429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-cerebras-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultCerebras500ServerError
        },
        {
            "call.in-progress.error-providerfault-cerebras-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultCerebras503ServerOverloadedError
        },
        {
            "pipeline-error-anthropic-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropic400BadRequestValidationFailed
        },
        {
            "pipeline-error-anthropic-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropic401Unauthorized
        },
        {
            "pipeline-error-anthropic-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropic403ModelAccessDenied
        },
        {
            "pipeline-error-anthropic-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropic429ExceededQuota
        },
        {
            "pipeline-error-anthropic-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropic500ServerError
        },
        {
            "pipeline-error-anthropic-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropic503ServerOverloadedError
        },
        {
            "pipeline-error-anthropic-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropicLlmFailed
        },
        {
            "call.in-progress.error-providerfault-anthropic-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultAnthropicLlmFailed
        },
        {
            "call.in-progress.error-vapifault-anthropic-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAnthropic400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-anthropic-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAnthropic401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-anthropic-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAnthropic403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-anthropic-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAnthropic429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-anthropic-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultAnthropic500ServerError
        },
        {
            "call.in-progress.error-providerfault-anthropic-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultAnthropic503ServerOverloadedError
        },
        {
            "pipeline-error-anthropic-bedrock-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropicBedrock400BadRequestValidationFailed
        },
        {
            "pipeline-error-anthropic-bedrock-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropicBedrock401Unauthorized
        },
        {
            "pipeline-error-anthropic-bedrock-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropicBedrock403ModelAccessDenied
        },
        {
            "pipeline-error-anthropic-bedrock-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropicBedrock429ExceededQuota
        },
        {
            "pipeline-error-anthropic-bedrock-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropicBedrock500ServerError
        },
        {
            "pipeline-error-anthropic-bedrock-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropicBedrock503ServerOverloadedError
        },
        {
            "pipeline-error-anthropic-bedrock-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropicBedrockLlmFailed
        },
        {
            "call.in-progress.error-providerfault-anthropic-bedrock-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultAnthropicBedrockLlmFailed
        },
        {
            "call.in-progress.error-vapifault-anthropic-bedrock-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAnthropicBedrock400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-anthropic-bedrock-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAnthropicBedrock401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-anthropic-bedrock-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAnthropicBedrock403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-anthropic-bedrock-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAnthropicBedrock429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-anthropic-bedrock-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultAnthropicBedrock500ServerError
        },
        {
            "call.in-progress.error-providerfault-anthropic-bedrock-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultAnthropicBedrock503ServerOverloadedError
        },
        {
            "pipeline-error-anthropic-vertex-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropicVertex400BadRequestValidationFailed
        },
        {
            "pipeline-error-anthropic-vertex-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropicVertex401Unauthorized
        },
        {
            "pipeline-error-anthropic-vertex-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropicVertex403ModelAccessDenied
        },
        {
            "pipeline-error-anthropic-vertex-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropicVertex429ExceededQuota
        },
        {
            "pipeline-error-anthropic-vertex-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropicVertex500ServerError
        },
        {
            "pipeline-error-anthropic-vertex-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropicVertex503ServerOverloadedError
        },
        {
            "pipeline-error-anthropic-vertex-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnthropicVertexLlmFailed
        },
        {
            "call.in-progress.error-providerfault-anthropic-vertex-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultAnthropicVertexLlmFailed
        },
        {
            "call.in-progress.error-vapifault-anthropic-vertex-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAnthropicVertex400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-anthropic-vertex-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAnthropicVertex401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-anthropic-vertex-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAnthropicVertex403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-anthropic-vertex-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAnthropicVertex429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-anthropic-vertex-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultAnthropicVertex500ServerError
        },
        {
            "call.in-progress.error-providerfault-anthropic-vertex-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultAnthropicVertex503ServerOverloadedError
        },
        {
            "pipeline-error-together-ai-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorTogetherAi400BadRequestValidationFailed
        },
        {
            "pipeline-error-together-ai-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorTogetherAi401Unauthorized
        },
        {
            "pipeline-error-together-ai-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorTogetherAi403ModelAccessDenied
        },
        {
            "pipeline-error-together-ai-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorTogetherAi429ExceededQuota
        },
        {
            "pipeline-error-together-ai-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorTogetherAi500ServerError
        },
        {
            "pipeline-error-together-ai-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorTogetherAi503ServerOverloadedError
        },
        {
            "pipeline-error-together-ai-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorTogetherAiLlmFailed
        },
        {
            "call.in-progress.error-providerfault-together-ai-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultTogetherAiLlmFailed
        },
        {
            "call.in-progress.error-vapifault-together-ai-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultTogetherAi400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-together-ai-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultTogetherAi401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-together-ai-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultTogetherAi403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-together-ai-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultTogetherAi429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-together-ai-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultTogetherAi500ServerError
        },
        {
            "call.in-progress.error-providerfault-together-ai-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultTogetherAi503ServerOverloadedError
        },
        {
            "pipeline-error-anyscale-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnyscale400BadRequestValidationFailed
        },
        {
            "pipeline-error-anyscale-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnyscale401Unauthorized
        },
        {
            "pipeline-error-anyscale-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnyscale403ModelAccessDenied
        },
        {
            "pipeline-error-anyscale-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnyscale429ExceededQuota
        },
        {
            "pipeline-error-anyscale-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnyscale500ServerError
        },
        {
            "pipeline-error-anyscale-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnyscale503ServerOverloadedError
        },
        {
            "pipeline-error-anyscale-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorAnyscaleLlmFailed
        },
        {
            "call.in-progress.error-providerfault-anyscale-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultAnyscaleLlmFailed
        },
        {
            "call.in-progress.error-vapifault-anyscale-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAnyscale400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-anyscale-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAnyscale401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-anyscale-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAnyscale403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-anyscale-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultAnyscale429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-anyscale-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultAnyscale500ServerError
        },
        {
            "call.in-progress.error-providerfault-anyscale-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultAnyscale503ServerOverloadedError
        },
        {
            "pipeline-error-openrouter-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorOpenrouter400BadRequestValidationFailed
        },
        {
            "pipeline-error-openrouter-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorOpenrouter401Unauthorized
        },
        {
            "pipeline-error-openrouter-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorOpenrouter403ModelAccessDenied
        },
        {
            "pipeline-error-openrouter-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorOpenrouter429ExceededQuota
        },
        {
            "pipeline-error-openrouter-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorOpenrouter500ServerError
        },
        {
            "pipeline-error-openrouter-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorOpenrouter503ServerOverloadedError
        },
        {
            "pipeline-error-openrouter-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorOpenrouterLlmFailed
        },
        {
            "call.in-progress.error-providerfault-openrouter-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultOpenrouterLlmFailed
        },
        {
            "call.in-progress.error-vapifault-openrouter-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultOpenrouter400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-openrouter-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultOpenrouter401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-openrouter-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultOpenrouter403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-openrouter-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultOpenrouter429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-openrouter-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultOpenrouter500ServerError
        },
        {
            "call.in-progress.error-providerfault-openrouter-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultOpenrouter503ServerOverloadedError
        },
        {
            "pipeline-error-perplexity-ai-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorPerplexityAi400BadRequestValidationFailed
        },
        {
            "pipeline-error-perplexity-ai-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorPerplexityAi401Unauthorized
        },
        {
            "pipeline-error-perplexity-ai-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorPerplexityAi403ModelAccessDenied
        },
        {
            "pipeline-error-perplexity-ai-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorPerplexityAi429ExceededQuota
        },
        {
            "pipeline-error-perplexity-ai-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorPerplexityAi500ServerError
        },
        {
            "pipeline-error-perplexity-ai-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorPerplexityAi503ServerOverloadedError
        },
        {
            "pipeline-error-perplexity-ai-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorPerplexityAiLlmFailed
        },
        {
            "call.in-progress.error-providerfault-perplexity-ai-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultPerplexityAiLlmFailed
        },
        {
            "call.in-progress.error-vapifault-perplexity-ai-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultPerplexityAi400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-perplexity-ai-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultPerplexityAi401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-perplexity-ai-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultPerplexityAi403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-perplexity-ai-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultPerplexityAi429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-perplexity-ai-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultPerplexityAi500ServerError
        },
        {
            "call.in-progress.error-providerfault-perplexity-ai-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultPerplexityAi503ServerOverloadedError
        },
        {
            "pipeline-error-deepinfra-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepinfra400BadRequestValidationFailed
        },
        {
            "pipeline-error-deepinfra-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepinfra401Unauthorized
        },
        {
            "pipeline-error-deepinfra-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepinfra403ModelAccessDenied
        },
        {
            "pipeline-error-deepinfra-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepinfra429ExceededQuota
        },
        {
            "pipeline-error-deepinfra-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepinfra500ServerError
        },
        {
            "pipeline-error-deepinfra-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepinfra503ServerOverloadedError
        },
        {
            "pipeline-error-deepinfra-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepinfraLlmFailed
        },
        {
            "call.in-progress.error-providerfault-deepinfra-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultDeepinfraLlmFailed
        },
        {
            "call.in-progress.error-vapifault-deepinfra-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultDeepinfra400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-deepinfra-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultDeepinfra401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-deepinfra-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultDeepinfra403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-deepinfra-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultDeepinfra429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-deepinfra-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultDeepinfra500ServerError
        },
        {
            "call.in-progress.error-providerfault-deepinfra-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultDeepinfra503ServerOverloadedError
        },
        {
            "pipeline-error-runpod-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorRunpod400BadRequestValidationFailed
        },
        {
            "pipeline-error-runpod-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorRunpod401Unauthorized
        },
        {
            "pipeline-error-runpod-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorRunpod403ModelAccessDenied
        },
        {
            "pipeline-error-runpod-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorRunpod429ExceededQuota
        },
        {
            "pipeline-error-runpod-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorRunpod500ServerError
        },
        {
            "pipeline-error-runpod-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorRunpod503ServerOverloadedError
        },
        {
            "pipeline-error-runpod-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorRunpodLlmFailed
        },
        {
            "call.in-progress.error-providerfault-runpod-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultRunpodLlmFailed
        },
        {
            "call.in-progress.error-vapifault-runpod-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultRunpod400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-runpod-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultRunpod401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-runpod-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultRunpod403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-runpod-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultRunpod429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-runpod-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultRunpod500ServerError
        },
        {
            "call.in-progress.error-providerfault-runpod-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultRunpod503ServerOverloadedError
        },
        {
            "pipeline-error-custom-llm-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCustomLlm400BadRequestValidationFailed
        },
        {
            "pipeline-error-custom-llm-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCustomLlm401Unauthorized
        },
        {
            "pipeline-error-custom-llm-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCustomLlm403ModelAccessDenied
        },
        {
            "pipeline-error-custom-llm-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCustomLlm429ExceededQuota
        },
        {
            "pipeline-error-custom-llm-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCustomLlm500ServerError
        },
        {
            "pipeline-error-custom-llm-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCustomLlm503ServerOverloadedError
        },
        {
            "pipeline-error-custom-llm-llm-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCustomLlmLlmFailed
        },
        {
            "call.in-progress.error-providerfault-custom-llm-llm-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultCustomLlmLlmFailed
        },
        {
            "call.in-progress.error-vapifault-custom-llm-400-bad-request-validation-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultCustomLlm400BadRequestValidationFailed
        },
        {
            "call.in-progress.error-vapifault-custom-llm-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultCustomLlm401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-custom-llm-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultCustomLlm403ModelAccessDenied
        },
        {
            "call.in-progress.error-vapifault-custom-llm-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultCustomLlm429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-custom-llm-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultCustomLlm500ServerError
        },
        {
            "call.in-progress.error-providerfault-custom-llm-503-server-overloaded-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultCustomLlm503ServerOverloadedError
        },
        {
            "call.in-progress.error-pipeline-ws-model-connection-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorPipelineWsModelConnectionFailed
        },
        {
            "pipeline-error-custom-voice-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCustomVoiceFailed
        },
        {
            "pipeline-error-cartesia-socket-hang-up",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCartesiaSocketHangUp
        },
        {
            "pipeline-error-cartesia-requested-payment",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCartesiaRequestedPayment
        },
        {
            "pipeline-error-cartesia-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCartesia500ServerError
        },
        {
            "pipeline-error-cartesia-502-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCartesia502ServerError
        },
        {
            "pipeline-error-cartesia-503-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCartesia503ServerError
        },
        {
            "pipeline-error-cartesia-522-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCartesia522ServerError
        },
        {
            "call.in-progress.error-vapifault-cartesia-socket-hang-up",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultCartesiaSocketHangUp
        },
        {
            "call.in-progress.error-vapifault-cartesia-requested-payment",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultCartesiaRequestedPayment
        },
        {
            "call.in-progress.error-providerfault-cartesia-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultCartesia500ServerError
        },
        {
            "call.in-progress.error-providerfault-cartesia-503-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultCartesia503ServerError
        },
        {
            "call.in-progress.error-providerfault-cartesia-522-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultCartesia522ServerError
        },
        {
            "pipeline-error-eleven-labs-voice-not-found",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsVoiceNotFound
        },
        {
            "pipeline-error-eleven-labs-quota-exceeded",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsQuotaExceeded
        },
        {
            "pipeline-error-eleven-labs-unauthorized-access",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsUnauthorizedAccess
        },
        {
            "pipeline-error-eleven-labs-unauthorized-to-access-model",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsUnauthorizedToAccessModel
        },
        {
            "pipeline-error-eleven-labs-professional-voices-only-for-creator-plus",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsProfessionalVoicesOnlyForCreatorPlus
        },
        {
            "pipeline-error-eleven-labs-blocked-free-plan-and-requested-upgrade",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsBlockedFreePlanAndRequestedUpgrade
        },
        {
            "pipeline-error-eleven-labs-blocked-concurrent-requests-and-requested-upgrade",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsBlockedConcurrentRequestsAndRequestedUpgrade
        },
        {
            "pipeline-error-eleven-labs-blocked-using-instant-voice-clone-and-requested-upgrade",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsBlockedUsingInstantVoiceCloneAndRequestedUpgrade
        },
        {
            "pipeline-error-eleven-labs-system-busy-and-requested-upgrade",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsSystemBusyAndRequestedUpgrade
        },
        {
            "pipeline-error-eleven-labs-voice-not-fine-tuned",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsVoiceNotFineTuned
        },
        {
            "pipeline-error-eleven-labs-invalid-api-key",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsInvalidApiKey
        },
        {
            "pipeline-error-eleven-labs-invalid-voice-samples",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsInvalidVoiceSamples
        },
        {
            "pipeline-error-eleven-labs-voice-disabled-by-owner",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsVoiceDisabledByOwner
        },
        {
            "pipeline-error-eleven-labs-vapi-voice-disabled-by-owner",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsVapiVoiceDisabledByOwner
        },
        {
            "pipeline-error-eleven-labs-blocked-account-in-probation",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsBlockedAccountInProbation
        },
        {
            "pipeline-error-eleven-labs-blocked-content-against-their-policy",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsBlockedContentAgainstTheirPolicy
        },
        {
            "pipeline-error-eleven-labs-missing-samples-for-voice-clone",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsMissingSamplesForVoiceClone
        },
        {
            "pipeline-error-eleven-labs-voice-not-fine-tuned-and-cannot-be-used",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsVoiceNotFineTunedAndCannotBeUsed
        },
        {
            "pipeline-error-eleven-labs-voice-not-allowed-for-free-users",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsVoiceNotAllowedForFreeUsers
        },
        {
            "pipeline-error-eleven-labs-max-character-limit-exceeded",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsMaxCharacterLimitExceeded
        },
        {
            "pipeline-error-eleven-labs-blocked-voice-potentially-against-terms-of-service-and-awaiting-verification",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabsBlockedVoicePotentiallyAgainstTermsOfServiceAndAwaitingVerification
        },
        {
            "pipeline-error-eleven-labs-500-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabs500ServerError
        },
        {
            "pipeline-error-eleven-labs-503-server-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorElevenLabs503ServerError
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-voice-not-found",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsVoiceNotFound
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-quota-exceeded",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsQuotaExceeded
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-unauthorized-access",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsUnauthorizedAccess
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-unauthorized-to-access-model",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsUnauthorizedToAccessModel
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-professional-voices-only-for-creator-plus",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsProfessionalVoicesOnlyForCreatorPlus
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-blocked-free-plan-and-requested-upgrade",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsBlockedFreePlanAndRequestedUpgrade
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-blocked-concurrent-requests-and-requested-upgrade",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsBlockedConcurrentRequestsAndRequestedUpgrade
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-blocked-using-instant-voice-clone-and-requested-upgrade",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsBlockedUsingInstantVoiceCloneAndRequestedUpgrade
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-system-busy-and-requested-upgrade",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsSystemBusyAndRequestedUpgrade
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-voice-not-fine-tuned",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsVoiceNotFineTuned
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-invalid-api-key",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsInvalidApiKey
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-invalid-voice-samples",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsInvalidVoiceSamples
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-voice-disabled-by-owner",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsVoiceDisabledByOwner
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-blocked-account-in-probation",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsBlockedAccountInProbation
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-blocked-content-against-their-policy",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsBlockedContentAgainstTheirPolicy
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-missing-samples-for-voice-clone",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsMissingSamplesForVoiceClone
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-voice-not-fine-tuned-and-cannot-be-used",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsVoiceNotFineTunedAndCannotBeUsed
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-voice-not-allowed-for-free-users",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsVoiceNotAllowedForFreeUsers
        },
        {
            "call.in-progress.error-vapifault-eleven-labs-max-character-limit-exceeded",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsMaxCharacterLimitExceeded
        },
        {
            ...
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultElevenLabsBlockedVoicePotentiallyAgainstTermsOfServiceAndAwaitingVerification
        },
        {
            "call.in-progress.error-providerfault-eleven-labs-system-busy-and-requested-upgrade",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultElevenLabsSystemBusyAndRequestedUpgrade
        },
        {
            "call.in-progress.error-providerfault-eleven-labs-500-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultElevenLabs500ServerError
        },
        {
            "call.in-progress.error-providerfault-eleven-labs-503-server-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultElevenLabs503ServerError
        },
        {
            "pipeline-error-playht-request-timed-out",
            ServerMessageStatusUpdateEndedReason.PipelineErrorPlayhtRequestTimedOut
        },
        {
            "pipeline-error-playht-invalid-voice",
            ServerMessageStatusUpdateEndedReason.PipelineErrorPlayhtInvalidVoice
        },
        {
            "pipeline-error-playht-unexpected-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorPlayhtUnexpectedError
        },
        {
            "pipeline-error-playht-out-of-credits",
            ServerMessageStatusUpdateEndedReason.PipelineErrorPlayhtOutOfCredits
        },
        {
            "pipeline-error-playht-invalid-emotion",
            ServerMessageStatusUpdateEndedReason.PipelineErrorPlayhtInvalidEmotion
        },
        {
            "pipeline-error-playht-voice-must-be-a-valid-voice-manifest-uri",
            ServerMessageStatusUpdateEndedReason.PipelineErrorPlayhtVoiceMustBeAValidVoiceManifestUri
        },
        {
            "pipeline-error-playht-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.PipelineErrorPlayht401Unauthorized
        },
        {
            "pipeline-error-playht-403-forbidden-out-of-characters",
            ServerMessageStatusUpdateEndedReason.PipelineErrorPlayht403ForbiddenOutOfCharacters
        },
        {
            "pipeline-error-playht-403-forbidden-api-access-not-available",
            ServerMessageStatusUpdateEndedReason.PipelineErrorPlayht403ForbiddenApiAccessNotAvailable
        },
        {
            "pipeline-error-playht-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.PipelineErrorPlayht429ExceededQuota
        },
        {
            "pipeline-error-playht-502-gateway-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorPlayht502GatewayError
        },
        {
            "pipeline-error-playht-504-gateway-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorPlayht504GatewayError
        },
        {
            "call.in-progress.error-vapifault-playht-request-timed-out",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultPlayhtRequestTimedOut
        },
        {
            "call.in-progress.error-vapifault-playht-invalid-voice",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultPlayhtInvalidVoice
        },
        {
            "call.in-progress.error-vapifault-playht-unexpected-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultPlayhtUnexpectedError
        },
        {
            "call.in-progress.error-vapifault-playht-out-of-credits",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultPlayhtOutOfCredits
        },
        {
            "call.in-progress.error-vapifault-playht-invalid-emotion",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultPlayhtInvalidEmotion
        },
        {
            "call.in-progress.error-vapifault-playht-voice-must-be-a-valid-voice-manifest-uri",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultPlayhtVoiceMustBeAValidVoiceManifestUri
        },
        {
            "call.in-progress.error-vapifault-playht-401-unauthorized",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultPlayht401Unauthorized
        },
        {
            "call.in-progress.error-vapifault-playht-403-forbidden-out-of-characters",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultPlayht403ForbiddenOutOfCharacters
        },
        {
            "call.in-progress.error-vapifault-playht-403-forbidden-api-access-not-available",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultPlayht403ForbiddenApiAccessNotAvailable
        },
        {
            "call.in-progress.error-vapifault-playht-429-exceeded-quota",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultPlayht429ExceededQuota
        },
        {
            "call.in-progress.error-providerfault-playht-502-gateway-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultPlayht502GatewayError
        },
        {
            "call.in-progress.error-providerfault-playht-504-gateway-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultPlayht504GatewayError
        },
        {
            "pipeline-error-custom-transcriber-failed",
            ServerMessageStatusUpdateEndedReason.PipelineErrorCustomTranscriberFailed
        },
        {
            "call.in-progress.error-vapifault-custom-transcriber-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultCustomTranscriberFailed
        },
        {
            "pipeline-error-deepgram-returning-400-no-such-model-language-tier-combination",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepgramReturning400NoSuchModelLanguageTierCombination
        },
        {
            "pipeline-error-deepgram-returning-401-invalid-credentials",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepgramReturning401InvalidCredentials
        },
        {
            "pipeline-error-deepgram-returning-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepgramReturning403ModelAccessDenied
        },
        {
            "pipeline-error-deepgram-returning-404-not-found",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepgramReturning404NotFound
        },
        {
            "pipeline-error-deepgram-returning-500-invalid-json",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepgramReturning500InvalidJson
        },
        {
            "pipeline-error-deepgram-returning-502-network-error",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepgramReturning502NetworkError
        },
        {
            "pipeline-error-deepgram-returning-502-bad-gateway-ehostunreach",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepgramReturning502BadGatewayEhostunreach
        },
        {
            "pipeline-error-deepgram-returning-econnreset",
            ServerMessageStatusUpdateEndedReason.PipelineErrorDeepgramReturningEconnreset
        },
        {
            "call.in-progress.error-vapifault-deepgram-returning-400-no-such-model-language-tier-combination",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultDeepgramReturning400NoSuchModelLanguageTierCombination
        },
        {
            "call.in-progress.error-vapifault-deepgram-returning-401-invalid-credentials",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultDeepgramReturning401InvalidCredentials
        },
        {
            "call.in-progress.error-vapifault-deepgram-returning-404-not-found",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultDeepgramReturning404NotFound
        },
        {
            "call.in-progress.error-vapifault-deepgram-returning-403-model-access-denied",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorVapifaultDeepgramReturning403ModelAccessDenied
        },
        {
            "call.in-progress.error-providerfault-deepgram-returning-500-invalid-json",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultDeepgramReturning500InvalidJson
        },
        {
            "call.in-progress.error-providerfault-deepgram-returning-502-network-error",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultDeepgramReturning502NetworkError
        },
        {
            "call.in-progress.error-providerfault-deepgram-returning-502-bad-gateway-ehostunreach",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultDeepgramReturning502BadGatewayEhostunreach
        },
        {
            "call.in-progress.error-warm-transfer-max-duration",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorWarmTransferMaxDuration
        },
        {
            "call.in-progress.error-warm-transfer-assistant-cancelled",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorWarmTransferAssistantCancelled
        },
        {
            "call.in-progress.error-warm-transfer-silence-timeout",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorWarmTransferSilenceTimeout
        },
        {
            "call.in-progress.error-warm-transfer-microphone-timeout",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorWarmTransferMicrophoneTimeout
        },
        { "assistant-ended-call", ServerMessageStatusUpdateEndedReason.AssistantEndedCall },
        {
            "assistant-said-end-call-phrase",
            ServerMessageStatusUpdateEndedReason.AssistantSaidEndCallPhrase
        },
        {
            "assistant-ended-call-with-hangup-task",
            ServerMessageStatusUpdateEndedReason.AssistantEndedCallWithHangupTask
        },
        {
            "assistant-ended-call-after-message-spoken",
            ServerMessageStatusUpdateEndedReason.AssistantEndedCallAfterMessageSpoken
        },
        ...
        { "assistant-join-timed-out", ServerMessageStatusUpdateEndedReason.AssistantJoinTimedOut },
        {
            ...
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorAssistantDidNotReceiveCustomerAudio
        },
        {
            "call.in-progress.error-transfer-failed",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorTransferFailed
        },
        ...
        { "customer-ended-call", ServerMessageStatusUpdateEndedReason.CustomerEndedCall },
        {
            ...
            ServerMessageStatusUpdateEndedReason.CustomerEndedCallBeforeWarmTransfer
        },
        {
            "customer-ended-call-after-warm-transfer-attempt",
            ServerMessageStatusUpdateEndedReason.CustomerEndedCallAfterWarmTransferAttempt
        },
        {
            "customer-ended-call-during-transfer",
            ServerMessageStatusUpdateEndedReason.CustomerEndedCallDuringTransfer
        },
        { "customer-did-not-answer", ServerMessageStatusUpdateEndedReason.CustomerDidNotAnswer },
        {
            "customer-did-not-give-microphone-permission",
            ServerMessageStatusUpdateEndedReason.CustomerDidNotGiveMicrophonePermission
        },
        ...
        { "manually-canceled", ServerMessageStatusUpdateEndedReason.ManuallyCanceled },
        {
            ...
            ServerMessageStatusUpdateEndedReason.PhoneCallProviderClosedWebsocket
        },
        {
        ...
        { "silence-timed-out", ServerMessageStatusUpdateEndedReason.SilenceTimedOut },
        {
            ...
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultOutboundSip403Forbidden
        },
        {
            "call.in-progress.error-providerfault-outbound-sip-407-proxy-authentication-required",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultOutboundSip407ProxyAuthenticationRequired
        },
        {
            "call.in-progress.error-providerfault-outbound-sip-408-request-timeout",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultOutboundSip408RequestTimeout
        },
        {
            "call.in-progress.error-providerfault-outbound-sip-480-temporarily-unavailable",
            ServerMessageStatusUpdateEndedReason.CallInProgressErrorProviderfaultOutboundSip480TemporarilyUnavailable
        },
        {
            "sip-outbound-unallocated-number",
            ServerMessageStatusUpdateEndedReason.SipOutboundUnallocatedNumber
        },
        {
            "sip-outbound-carrier-released-call",
            ServerMessageStatusUpdateEndedReason.SipOutboundCarrierReleasedCall
        },
        {
            "call.ringing.hook-executed-say",
            ServerMessageStatusUpdateEndedReason.CallRingingHookExecutedSay
        },
        {
            "call.ringing.hook-executed-transfer",
            ServerMessageStatusUpdateEndedReason.CallRingingHookExecutedTransfer
        },
        {
            "call.ending.hook-executed-say",
            ServerMessageStatusUpdateEndedReason.CallEndingHookExecutedSay
        },
        {
            "call.ending.hook-executed-transfer",
            ServerMessageStatusUpdateEndedReason.CallEndingHookExecutedTransfer
        },
        {
            "call.ringing.sip-inbound-caller-hungup-before-call-connect",
            ServerMessageStatusUpdateEndedReason.CallRingingSipInboundCallerHungupBeforeCallConnect
        },
        {
            "twilio-failed-to-connect-call",
            ServerMessageStatusUpdateEndedReason.TwilioFailedToConnectCall
        },
        {
            "twilio-reported-customer-misdialed",
            ServerMessageStatusUpdateEndedReason.TwilioReportedCustomerMisdialed
        },
    ...
    public override ServerMessageStatusUpdateEndedReason Read(
    ...
    public override void Write(
        ...
        ServerMessageStatusUpdateEndedReason value,
        global::System.Text.Json.JsonSerializerOptions options
    )
    {
    ...
    public override ServerMessageStatusUpdateEndedReason ReadAsPropertyName(
        ref global::System.Text.Json.Utf8JsonReader reader,
        global::System.Type typeToConvert,
        global::System.Text.Json.JsonSerializerOptions options
    )

...
[Serializable]
public record SimulationRunListItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required SimulationRunListItemStatus Status { get; set; }
    ...
    public required SimulationRunListSummary Summary { get; set; }

...
[Serializable]
public record CreateAssistantDraftDto : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public CreateAssistantDraftDtoFirstMessageMode? FirstMessageMode { get; set; }
    ...
    public IEnumerable<CreateAssistantDraftDtoClientMessagesItem>? ClientMessages { get; set; }
    ...
    public IEnumerable<CreateAssistantDraftDtoServerMessagesItem>? ServerMessages { get; set; }
    ...
    public OneOf<CreateAssistantDraftDtoBackgroundSoundZero, string>? BackgroundSound { get; set; }

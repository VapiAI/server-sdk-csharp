...
public record Subscription : IJsonOnDeserialized
{
    ...
    /// </summary>
    [JsonPropertyName("pciCommonPaperAgreementId")]
    ...
    /// on file, or invoiced.
    /// </summary>
    [JsonPropertyName("billingCollectionMethod")]
    public SubscriptionBillingCollectionMethod? BillingCollectionMethod { get; set; }

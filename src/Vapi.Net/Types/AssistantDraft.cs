...
[Serializable]
public record AssistantDraft : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public AssistantDraftFirstMessageMode? FirstMessageMode { get; set; }
    ...
    public IEnumerable<AssistantDraftClientMessagesItem>? ClientMessages { get; set; }
    ...
    public IEnumerable<AssistantDraftServerMessagesItem>? ServerMessages { get; set; }
    ...
    public OneOf<AssistantDraftBackgroundSoundZero, string>? BackgroundSound { get; set; }

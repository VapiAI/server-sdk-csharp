...
[Serializable]
public record FallbackMicrosoftVoice : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required FallbackMicrosoftVoiceVoiceId VoiceId { get; set; }
    ...
    public FallbackMicrosoftVoiceStyle? Style { get; set; }
    ...
    public FallbackMicrosoftVoiceRole? Role { get; set; }

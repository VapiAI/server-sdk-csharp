...
[Serializable]
public record BarInsightFromCallTable : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required BarInsightFromCallTableType Type { get; set; }
    ...
    public BarInsightFromCallTableGroupBy? GroupBy { get; set; }

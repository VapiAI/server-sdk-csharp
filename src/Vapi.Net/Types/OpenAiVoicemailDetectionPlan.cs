...
[Serializable]
public record OpenAiVoicemailDetectionPlan : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required OpenAiVoicemailDetectionPlanProvider Provider { get; set; }
    ...
    public OpenAiVoicemailDetectionPlanType? Type { get; set; }

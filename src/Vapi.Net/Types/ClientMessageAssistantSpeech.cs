...
[Serializable]
public record ClientMessageAssistantSpeech : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required ClientMessageAssistantSpeechType Type { get; set; }
    ...
    public ClientMessageAssistantSpeechSource? Source { get; set; }

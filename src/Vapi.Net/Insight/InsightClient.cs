...
public partial class InsightClient
{
    ...
    public async Task<InsightPaginatedResponse> InsightControllerFindAllAsync(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<InsightPaginatedResponse>(responseBody)!;
            }
    ...
    public async Task<object> InsightControllerCreateAsync(
        object request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    public async Task<object> InsightControllerFindOneAsync(
        string id,
    ...
    public async Task<object> InsightControllerRemoveAsync(
        string id,
    ...
    public async Task<object> InsightControllerUpdateAsync(
        string id,
    ...
    public async Task<InsightRunResponse> InsightControllerRunAsync(
        string id,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<InsightRunResponse>(responseBody)!;
            }
            catch (JsonException e)
            {
                throw new VapiClientException("Failed to deserialize response", e);
    ...
    public async Task<InsightRunResponse> InsightControllerPreviewAsync(
        object request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )

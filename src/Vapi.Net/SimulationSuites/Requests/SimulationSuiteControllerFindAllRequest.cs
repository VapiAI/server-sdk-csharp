...
[Serializable]
public record SimulationSuiteControllerFindAllRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public SimulationSuiteControllerFindAllRequestSortOrder? SortOrder { get; set; }

    /// <summary>
    /// This is the column to sort by. Defaults to 'createdAt'.
    /// </summary>
    [JsonIgnore]
    public SimulationSuiteControllerFindAllRequestSortBy? SortBy { get; set; }

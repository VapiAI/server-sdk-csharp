...
[Serializable]
public record PersonalityControllerFindAllRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public PersonalityControllerFindAllRequestSortOrder? SortOrder { get; set; }

    /// <summary>
    /// This is the column to sort by. Defaults to 'createdAt'.
    /// </summary>
    [JsonIgnore]
    public PersonalityControllerFindAllRequestSortBy? SortBy { get; set; }

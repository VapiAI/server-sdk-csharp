...
namespace Vapi.Net.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static Vapi.Net.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new Vapi.Net.Core.MultipartFormRequest
        {
